...
<style>
	...
	.enviar			{border:0px solid rgba(255,112,0,1); border-radius:10px; width:340px; height:50px; font-size:30px; color:rgba(255,255,255,1); background-color:rgba(0,0,0,1); padding:12px 0px; cursor:pointer}
</style>
</head>
<body>
<?php
