...
<style>
	body				{background:url(../common/imagenes/primax.svg) no-repeat center center; background-size:auto 180%}
	...
	select			{font-size:30px; background-color:rgba(205,205,205,1); width:340px; height:50px; text-align:center}
	option			{font-size:24px; background-color:rgba(255,112,0,0.5)}
	.enviar			{border:0px solid rgba(255,112,0,1); border-radius:10px; width:340px; height:50px; font-size:30px; color:rgba(255,112,0,1); background-color:rgba(0,0,0,1); cursor:pointer}
</style>
</head>
<body>
<?php
...
<table style="background-color:none" height=100% width=100%>
  ...
  <tr style="background-color:rgba(0,240,0,0); height:88%; vertical-align:middle">
		...
		<td style="text-align:center">
			...
			<span style="font-size:24px">APP para PC Escritorio<br><br><br><br></span>
