...
?>
<script type="text/javascript">document.write('<table height="' + window.innerHeight*0.98 + '" style="width:100vw; background-color:rgba(255,115,0,0); margin-left:auto; margin-right:auto" border="0" cellpadding="0" cellspacing="0">')</script>
	...
	<tr style="background-color:rgba(255,115,0,0.0); height:30%">
		<td style="text-align:center">
			...
			<div style="margin-left:24%; margin-top:0%; width:52%; text-align:center; background-color:rgba(0,255,0,0.0)">
