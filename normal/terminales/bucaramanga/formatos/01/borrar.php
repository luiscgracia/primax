...
if (mysqli_num_rows($resultado)>0)
	{$query = "DELETE FROM formulario".basename(dirname(__FILE__))." WHERE consecutivo=$consec"; $result = mysqli_query($conexion,$query);
	echo "<br>"; echo "<div style='text-align:center'><br><br><button>CONSECUTIVO BORRADO</button></div>";}
  	else {echo "<br>"; echo "<div style='text-align:center'><br><br><button>ESE CONSECUTIVO NO EXISTE EN LA BASE DE DATOS</button></div>";}
?>
</body>
</html>
