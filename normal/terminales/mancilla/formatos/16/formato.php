...
<div style="position:absolute; left:50%; margin-left:-408px; top:0px; width:816px; height:1056px; overflow:hidden; border:0px solid rgba(0,0,0,0.25)">
	...
	<div style="position:absolute; left: 18.15cm; top: 0.40cm"><input name="estado" type="text" style="font-size:7px; background-color:rgba(0,0,0,0); color:rgba(0,0,0,0.33); border:0" value="VIGENTE" readonly></div>
