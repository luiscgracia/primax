...
<div style="position:absolute; left:50%; margin-left:-408px; top:0px; width:816px; height:2112px; overflow:hidden; border:0px solid rgba(0,0,0,0.25)">
	...
	<div style="position:absolute; left:18.65cm; top: 0.95cm"><input name="estado" type="text" value="VIGENTE" style="font-size:7px; color:rgba(255,255,255,1); background-color:rgba(0,0,0,0); border:0" readonly></div>
