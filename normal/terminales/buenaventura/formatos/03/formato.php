...
<!--	<div style="position:absolute; left:0px; top:	  0px"><img src="<? echo $milimetrado; ?>"	width="816px" height="auto"></div> -->
	...
	<div style="position:absolute; left:18.30cm; top: 1.29cm"><input name="estado" type="text" value="VIGENTE" style="font-size:7px; color:rgba(255,255,255,1); background-color:rgba(0,0,0,0); border:0" readonly></div>
