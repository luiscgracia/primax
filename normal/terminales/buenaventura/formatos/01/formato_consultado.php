...
<script>
	...
	document.title = '<? echo strtoupper($terminal); ?> - <? echo $$formulario; ?> #<? if ($consecutivo <= 9) {echo "000";} else {if ($consecutivo <= 99) {echo "00";} else {if ($consecutivo <= 999) {echo "0";}}} echo $consecutivo;?>';
</script>
</head>
<body>
<?php
...
<!--	<div style="position:absolute; left:18.00cm; top:1.50cm; color:rgba(0,0,0,1)"><span style="font-size:7px; font-family:Arlrdbd"><?echo strtoupper($terminal);?></span></div>-->
	<div style="position:absolute; left:18.00cm; top:1.30cm; color:rgba(0,0,0,1)"><span style="font-size:7px; font-family:Arlrdbd"><?echo $usuario;?>@primax.com.co</span></div>
	...
	<!-- *****************************************			 sección B			 ***************************************** -->
	<div style="position:absolute; left:12.45cm; top: 4.64cm" class="radio"><?if ($cambio == 'CME') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:12.45cm; top: 4.96cm" class="radio"><?if ($cambio == 'CDE') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:17.05cm; top: 5.04cm"><?if ($cambio == 'CDE') {echo $pedidocambio;}?></div>

	<!-- *****************************************			 sección C			 ***************************************** -->
	<div style="position:absolute; left: 9.78cm; top: 6.12cm" class="radio"><?if ($C1 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 6.12cm" class="radio"><?if ($C1 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 6.42cm" class="radio"><?if ($C2 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 6.42cm" class="radio"><?if ($C2 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 6.72cm" class="radio"><?if ($C3 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 6.72cm" class="radio"><?if ($C3 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 7.02cm" class="radio"><?if ($C4 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 7.02cm" class="radio"><?if ($C4 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 7.32cm" class="radio"><?if ($C5 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 7.32cm" class="radio"><?if ($C5 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 7.62cm" class="radio"><?if ($C6 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 7.62cm" class="radio"><?if ($C6 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 7.92cm" class="radio"><?if ($C7 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 7.92cm" class="radio"><?if ($C7 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 8.22cm" class="radio"><?if ($C8 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 8.22cm" class="radio"><?if ($C8 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 8.52cm" class="radio"><?if ($C9 == 'SI')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 8.52cm" class="radio"><?if ($C9 == 'NO')	{echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 8.82cm" class="radio"><?if ($C10 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 8.82cm" class="radio"><?if ($C10 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 9.12cm" class="radio"><?if ($C11 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 9.12cm" class="radio"><?if ($C11 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 9.42cm" class="radio"><?if ($C12 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 9.42cm" class="radio"><?if ($C12 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top: 9.72cm" class="radio"><?if ($C13 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top: 9.72cm" class="radio"><?if ($C13 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top:10.02cm" class="radio"><?if ($C14 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top:10.02cm" class="radio"><?if ($C14 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top:10.32cm" class="radio"><?if ($C15 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top:10.32cm" class="radio"><?if ($C15 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top:10.62cm" class="radio"><?if ($C16 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top:10.62cm" class="radio"><?if ($C16 == 'NO') {echo '&#10687;';}?></div>
				<!-- **************************************			 sección EXCAVACION			 ************************************** -->
	<div style="position:absolute; left: 9.78cm; top:11.22cm" class="radio"><?if ($C17 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top:11.22cm" class="radio"><?if ($C17 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top:11.52cm" class="radio"><?if ($C18 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top:11.52cm" class="radio"><?if ($C18 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.78cm; top:11.82cm" class="radio"><?if ($C19 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.38cm; top:11.82cm" class="radio"><?if ($C19 == 'NO') {echo '&#10687;';}?></div>
				<!-- ********************************			 cambio de columna de preguntas			 ******************************** -->
				<!-- ********************************			 sección SUSTANCIAS PELIGROSAS			 ******************************** -->
	<div style="position:absolute; left:19.08cm; top: 6.42cm" class="radio"><?if ($C20 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 6.42cm" class="radio"><?if ($C20 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top: 6.72cm" class="radio"><?if ($C21 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 6.72cm" class="radio"><?if ($C21 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top: 7.02cm" class="radio"><?if ($C22 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 7.02cm" class="radio"><?if ($C22 == 'NO') {echo '&#10687;';}?></div>
				<!-- ********************************			 sección FUENTES DE IGNICIÓN				 ******************************** -->
	<div style="position:absolute; left:19.08cm; top: 7.62cm" class="radio"><?if ($C23 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 7.62cm" class="radio"><?if ($C23 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top: 7.92cm" class="radio"><?if ($C24 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 7.92cm" class="radio"><?if ($C24 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top: 8.22cm" class="radio"><?if ($C25 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 8.22cm" class="radio"><?if ($C25 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top: 8.52cm" class="radio"><?if ($C26 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 8.52cm" class="radio"><?if ($C26 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top: 8.82cm" class="radio"><?if ($C27 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 8.82cm" class="radio"><?if ($C27 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top: 9.12cm" class="radio"><?if ($C28 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 9.12cm" class="radio"><?if ($C28 == 'NO') {echo '&#10687;';}?></div>
				<!-- ********************************			  sección ENERGÍAS PELIGROSAS				 ******************************** -->
	<div style="position:absolute; left:19.08cm; top: 9.72cm" class="radio"><?if ($C29 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top: 9.72cm" class="radio"><?if ($C29 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top:10.02cm" class="radio"><?if ($C30 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top:10.02cm" class="radio"><?if ($C30 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top:10.32cm" class="radio"><?if ($C31 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top:10.32cm" class="radio"><?if ($C31 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top:10.62cm" class="radio"><?if ($C32 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top:10.62cm" class="radio"><?if ($C32 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top:10.92cm" class="radio"><?if ($C33 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top:10.92cm" class="radio"><?if ($C33 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top:11.22cm" class="radio"><?if ($C34 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top:11.22cm" class="radio"><?if ($C34 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top:11.52cm" class="radio"><?if ($C35 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top:11.52cm" class="radio"><?if ($C35 == 'NO') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.08cm; top:12.12cm" class="radio"><?if ($C36 == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:19.68cm; top:12.12cm" class="radio"><?if ($C36 == 'NO') {echo '&#10687;';}?></div>

	<div style="position:absolute; left: 7.65cm; top:12.60cm"><?echo substr($otrasactividades,0,63);?></div>
	
	<!-- *****************************************			 sección D			 ***************************************** -->
	<div style="position:absolute; left: 8.70cm; top:13.85cm" class="checkbox"><?if ($D1=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left: 8.70cm; top:14.15cm" class="checkbox"><?if ($D2=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left: 8.70cm; top:14.45cm" class="checkbox"><?if ($D3=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left: 8.70cm; top:14.75cm" class="checkbox"><?if ($D4=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left: 8.70cm; top:15.05cm" class="checkbox"><?if ($D5=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left: 8.70cm; top:15.35cm" class="checkbox"><?if ($D6=='on')	{echo '&#10004;';}?></div>
				<!-- ********************************			 cambio de columna de preguntas			 ******************************** -->
	<div style="position:absolute; left:17.68cm; top:13.85cm" class="checkbox"><?if ($D7=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left:17.68cm; top:14.15cm" class="checkbox"><?if ($D8=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left:17.68cm; top:14.45cm" class="checkbox"><?if ($D9=='on')	{echo '&#10004;';}?></div>
	<div style="position:absolute; left:17.68cm; top:14.75cm" class="checkbox"><?if ($D10=='on') {echo '&#10004;';}?></div>
	<div style="position:absolute; left:17.68cm; top:15.05cm" class="checkbox"><?if ($D11=='on') {echo '&#10004;';}?></div>
	<div style="position:absolute; left:17.68cm; top:15.35cm" class="checkbox"><?if ($D12=='on') {echo '&#10004;';}?></div>
	...
	<!-- *****************************************			 sección F			 ***************************************** -->
	<div style="position:absolute; left: 3.73cm; top:17.85cm" class="radio"><?if ($empleado == 'E')  {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 9.98cm; top:17.85cm" class="radio"><?if ($empleado == 'CP') {echo '&#10687;';}?></div>
	...
	<!-- *****************************************			 sección G			 ***************************************** -->
	<div style="position:absolute; left: 2.02cm; top:19.65cm" class="radio"><?if ($docum_adic == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left: 2.02cm; top:19.98cm" class="radio"><?if ($docum_adic == 'NO') {echo '&#10687;';}?></div>
	...
	<!-- *****************************************			 sección H			 ***************************************** -->
	<div style="position:absolute; left: 6.87cm; top:22.81cm" class="radio"><?if ($completado == 'SI') {echo '&#10687;';}?></div>
	<div style="position:absolute; left:10.27cm; top:22.81cm" class="radio"><?if ($completado == 'NO') {echo '&#10687;';}?></div>
