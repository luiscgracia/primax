...
$nivel11_mt = $_REQUEST['nivel11_mt'];
$nivel11_cm = $_REQUEST['nivel11_cm'];
$nivel11_mm = $_REQUEST['nivel11_mm'];
$nivel12_mt = $_REQUEST['nivel12_mt'];
$nivel12_cm = $_REQUEST['nivel12_cm'];
$nivel12_mm = $_REQUEST['nivel12_mm'];
$nivel13_mt = $_REQUEST['nivel13_mt'];
$nivel13_cm = $_REQUEST['nivel13_cm'];
$nivel13_mm = $_REQUEST['nivel13_mm'];
$agua1_mt = $_REQUEST['agua1_mt'];
$agua1_cm = $_REQUEST['agua1_cm'];
$agua1_mm = $_REQUEST['agua1_mm'];
$temperatura1_baja = $_REQUEST['temperatura1_baja'];
$temperatura1_media = $_REQUEST['temperatura1_media'];
$temperatura1_alta = $_REQUEST['temperatura1_alta'];
$temperatura1_promedio = $_REQUEST['temperatura1_promedio'];
$alarma_alto = $_REQUEST['alarma_alto'];
$alarma_alto_alto = $_REQUEST['alarma_alto_alto'];
$tanque_drenaje1 = $_REQUEST['tanque_drenaje1'];
$referencia1_medida_mt = $_REQUEST['referencia1_medida_mt'];
$referencia1_medida_cm = $_REQUEST['referencia1_medida_cm'];
$referencia1_medida_mm = $_REQUEST['referencia1_medida_mm'];
$referencia1_aforo_mt = $_REQUEST['referencia1_aforo_mt'];
$referencia1_aforo_cm = $_REQUEST['referencia1_aforo_cm'];
$referencia1_aforo_mm = $_REQUEST['referencia1_aforo_mm'];
$dif_alt_referencia1 = $_REQUEST['dif_alt_referencia1'];
$A1 = $_REQUEST['A1'];
$A2 = $_REQUEST['A2'];
$A3 = $_REQUEST['A3'];
$A31 = $_REQUEST['A31'];
...
$nivel21_mt = $_REQUEST['nivel21_mt'];
$nivel21_cm = $_REQUEST['nivel21_cm'];
$nivel21_mm = $_REQUEST['nivel21_mm'];
$nivel22_mt = $_REQUEST['nivel22_mt'];
$nivel22_cm = $_REQUEST['nivel22_cm'];
$nivel22_mm = $_REQUEST['nivel22_mm'];
$nivel23_mt = $_REQUEST['nivel23_mt'];
$nivel23_cm = $_REQUEST['nivel23_cm'];
$nivel23_mm = $_REQUEST['nivel23_mm'];
$agua2_mt = $_REQUEST['agua2_mt'];
$agua2_cm = $_REQUEST['agua2_cm'];
$agua2_mm = $_REQUEST['agua2_mm'];
$temperatura2_baja = $_REQUEST['temperatura2_baja'];
$temperatura2_media = $_REQUEST['temperatura2_media'];
$temperatura2_alta = $_REQUEST['temperatura2_alta'];
$temperatura2_promedio = $_REQUEST['temperatura2_promedio'];
$referencia2_manual_mt = $_REQUEST['referencia2_manual_mt'];
$referencia2_manual_cm = $_REQUEST['referencia2_manual_cm'];
$referencia2_manual_mm = $_REQUEST['referencia2_manual_mm'];
$referencia2_aforo_mt = $_REQUEST['referencia2_aforo_mt'];
$referencia2_aforo_cm = $_REQUEST['referencia2_aforo_cm'];
$referencia2_aforo_mm = $_REQUEST['referencia2_aforo_mm'];
$dif_alt_referencia2 = $_REQUEST['dif_alt_referencia2'];
...
`temperatura1_media`, 
`temperatura1_alta`, 
`temperatura1_promedio`, 
`alarma_alto`, 
`alarma_alto_alto`, 
`tanque_drenaje1`, 
`referencia1_medida_mt`, 
`referencia1_medida_cm`, 
`referencia1_medida_mm`, 
`referencia1_aforo_mt`, 
`referencia1_aforo_cm`, 
`referencia1_aforo_mm`, 
`dif_alt_referencia1`, 
`A1`, 
`A2`, 
`A3`, 
...
`temperatura2_media`, 
`temperatura2_alta`, 
`temperatura2_promedio`, 
`referencia2_manual_mt`, 
`referencia2_manual_cm`, 
`referencia2_manual_mm`, 
`referencia2_aforo_mt`, 
`referencia2_aforo_cm`, 
`referencia2_aforo_mm`, 
`dif_alt_referencia2`, 
`api_observado`, 
`temperatura`, 
`marcacion`, 
