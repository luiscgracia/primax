...
<div style="position:absolute; left:50%; margin-left:-408px; top:0px; width:816px; height:2112px; overflow:hidden; border:0px solid rgba(0,0,0,0.25)">
	...
	<div style="position:absolute; left: 18.15cm; top: 0.80cm"><input name=estado type=text value=<? echo $estado_formulario1; ?> style="font-size:7px; background-color:rgba(0,0,0,0); color:rgba(0,0,0,1); border:0" readonly></div>
...
<!-- *****************************************			 sección A			 ***************************************** -->
	...
	<div style="position:absolute; left:19.35cm; top: 1.92cm"><input name=certhabilit type=text style="width: 1.0cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value='' required></div>
	<div style="position:absolute; left: 4.95cm; top: 2.42cm"><input name=empresaA		type=text	style=width:5.00cm maxlength=30 onkeyup=mayuscula(this) pattern=.{1,} value='' required></div>
	<div style="position:absolute; left:10.15cm; top: 2.42cm"><input name=nombreA			type=text	style=width:5.00cm maxlength=30 onkeyup=mayuscula(this) pattern=.{1,} value='' required></div>

<!-- *****************************************			 sección B			 ***************************************** -->
	<div style="position:absolute; left: 6.05cm; top: 3.33cm"><input name=descripcion type=text style=width:14.40cm maxlength=90 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	<div style="position:absolute; left: 6.05cm; top: 3.75cm"><input name=equipos 		type=text style=width:14.40cm maxlength=90 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>

<!-- *****************************************			 sección C			 ***************************************** -->
	<div style="position:absolute; left: 6.05cm; top: 4.64cm"><input name=ejecutorC 	type=text style=width:5.00cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	<div style="position:absolute; left: 6.05cm; top: 5.06cm"><input name=inspectorC	type=text style=width:5.00cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
...
<!-- *****************************************			 sección D			 ***************************************** -->
	...
	<div style="position:absolute; left: 2.70cm; top: 6.84cm"><input name=emisorD			type=text style=width:5.00cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>

<!-- *****************************************			 sección E			 ***************************************** -->
	<div style="position:absolute; left: 1.47cm; top: 7.75cm"><input name=EPP_B				type=checkbox checked disabled></div>
	<div style="position:absolute; left:15.45cm; top: 7.80cm"><input name=otrosE 			type=text style=width:5.00cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	<div style="position:absolute; left: 1.47cm; top: 8.15cm"><input name=EPP_CE			type=checkbox required></div>
	<div style="position:absolute; left: 1.47cm; top: 8.55cm"><input name=EPP_AE			type=checkbox required></div>
	
<!-- *****************************************			 sección F			 ***************************************** -->
<!-- ******************** AISLAMIENTO ELÉCTRICO ******************** -->
	<div style="position:absolute; left: 5.25cm; top: 9.90cm"><input name=FAE1 id=FAE1	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 3.85cm; top:10.45cm"><input name=equiposAE 		type=text style="width:6.50cm; background-color:white" maxlength=45 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	<div style="position:absolute; left: 2.58cm; top:10.90cm"><input name=voltajeF id=menor400	type=radio value=-400		onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 8.72cm; top:11.65cm"><input name=AE1 id=AE1		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 8.72cm; top:12.42cm"><input name=AE2 id=AE2		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 8.72cm; top:13.17cm"><input name=AE3 id=AE3		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 8.72cm; top:13.88cm"><input name=AE4 id=AE4		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 8.72cm; top:14.67cm"><input name=AE5 id=AE5		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 8.72cm; top:15.62cm"><input name=AE6 id=AE6		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
...
<!-- ******************** AISLAMIENTO MECÁNICO ********************* -->
	<div style="position:absolute; left:15.15cm; top: 9.90cm"><input name=FAM1 id=FAM1		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:13.75cm; top:10.45cm"><input name=equiposAM 			type=text style="width:6.50cm; background-color:white" maxlength=45 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	<div style="position:absolute; left:15.15cm; top:10.90cm"><input name=apequipos id=APE	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:11.65cm"><input name=AM1 id=AM1			type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:12.42cm"><input name=AM2 id=AM2			type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:13.17cm"><input name=AM3 id=AM3			type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:13.97cm"><input name=AM4 id=AM4			type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:14.82cm"><input name=AM5 id=AM5			type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:15.66cm"><input name=AM6 id=AM6			type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:16.45cm"><input name=F1 id=F1	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:16.95cm"><input name=F2 id=F2	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:17.45cm"><input name=F3 id=F3	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:17.95cm"><input name=F4 id=F4	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:18.45cm"><input name=F5 id=F5	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:19.07cm"><input name=F6 id=F6	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:19.70cm"><input name=F7 id=F7	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:20.20cm"><input name=F8 id=F8	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:20.70cm"><input name=F9 id=F9	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:21.92cm"><input name=F10 id=F10	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:22.54cm"><input name=F11 id=F11	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:23.05cm"><input name=F12 id=F12	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:23.55cm"><input name=F13 id=F13	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:24.05cm"><input name=F14 id=F14	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
...
<!-- *****************************************			 sección G			 ***************************************** -->
	<div style="position:absolute; left: 1.05cm; top:25.80cm"><input name=GA1 		type=text style=width:3.40cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	<div style="position:absolute; left: 4.60cm; top:25.85cm">SI</div><div style="position:absolute; left: 4.75cm; top:25.75cm"><input name=GB1 id=GB1	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 6.25cm; top:25.80cm"><input name=GC1 		type=text style=width:2.90cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	...
	<div style="position:absolute; left:12.18cm; top:25.80cm"><input name=GF1 		type=text style=width:2.90cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	...
	<div style="position:absolute; left:18.42cm; top:25.85cm">SI</div><div style="position:absolute; left:18.57cm; top:25.75cm"><input name=GI1 id=GI1	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 1.05cm; top:26.19cm"><input name=GA2			type=text style=width:3.40cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left: 4.60cm; top:26.24cm">SI</div><div style="position:absolute; left: 4.75cm; top:26.14cm"><input name=GB2 id=GB2	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 6.25cm; top:26.19cm"><input name=GC2			type=text style=width:2.90cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:12.18cm; top:26.19cm"><input name=GF2			type=text style=width:2.90cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:18.42cm; top:26.24cm">SI</div><div style="position:absolute; left:18.57cm; top:26.14cm"><input name=GI2 id=GI2	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 1.05cm; top:26.59cm"><input name=GA3			type=text style=width:3.40cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left: 4.60cm; top:26.64cm">SI</div><div style="position:absolute; left: 4.75cm; top:26.54cm"><input name=GB3 id=GB3	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 6.25cm; top:26.59cm"><input name=GC3			type=text style=width:2.90cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:12.18cm; top:26.59cm"><input name=GF3			type=text style=width:2.90cm maxlength=20 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:18.42cm; top:26.64cm">SI</div><div style="position:absolute; left:18.57cm; top:26.54cm"><input name=GI3 id=GI3	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
...
<!-- *****************************************			 empieza el RETIRO			 ***************************************** -->
<!-- *****************************************			 sección H			 ***************************************** -->
	<div style="position:absolute; left:10.77cm; top:29.43cm"><input name=H1	type=text style=width:09.62cm maxlength= 60 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:10.77cm; top:29.83cm"><input name=H2	type=text style=width:09.62cm maxlength= 60 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:10.77cm; top:30.23cm"><input name=H3 type=text style="width:40%; text-align:center" maxlength=5 pattern=^(([0-9]){1,2}?(.\d)?(\d)?)$ inputmode=numeric value='' required></div>
	<div style="position:absolute; left:10.77cm; top:30.63cm"><input name=H4 type=text style="width:40%; text-align:center" maxlength=5 pattern=^(([0-9]){1,2}?(.\d)?(\d)?)$ inputmode=numeric value='' required></div>
	<div style="position:absolute; left:10.77cm; top:31.03cm"><input name=H5	type=text style=width:09.62cm maxlength= 60 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left: 3.84cm; top:31.43cm"><input name=H6	type=text style=width:16.58cm maxlength=100 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:18.62cm; top:31.90cm"><input name=H7	id=H7		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:32.30cm"><input name=H8	id=H8		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:32.70cm"><input name=H9	id=H9		type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:33.10cm"><input name=H10 id=H10	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:33.50cm"><input name=H11 id=H11	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:33.90cm"><input name=H12 id=H12	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:34.30cm"><input name=H13 id=H13	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left:18.62cm; top:34.70cm"><input name=H14 id=H14	type=radio value=SI onclick=gestionarClickRadio(this) required></div>
...
<!-- *****************************************			 sección I			 ***************************************** -->
	<div style="position:absolute; left:19.35cm; top:35.73cm"><input name=cuadro type=text style="width: 1.0cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value='' required></div>
	<div style="position:absolute; left: 3.65cm; top:36.20cm"><input name=descripcionI type=text style=width:8.70cm maxlength=60 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	<div style="position:absolute; left:14.77cm; top:36.20cm"><input name=autorizadoI	 type=text style=width:5.00cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
	...
	<div style="position:absolute; left: 2.18cm; top:37.09cm"><input name=IB1 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:37.09cm"><input name=ID1 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:37.09cm"><input name=IE1 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:37.09cm"><input name=IF1 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:37.18cm"><input name=IH1 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:37.18cm"><input name=II1 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:37.18cm"><input name=IJ1 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:37.18cm"><input name=IL1 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:37.39cm"><input name=IB2 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:37.39cm"><input name=ID2 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:37.39cm"><input name=IE2 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:37.39cm"><input name=IF2 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:37.48cm"><input name=IH2 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:37.48cm"><input name=II2 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:37.48cm"><input name=IJ2 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:37.48cm"><input name=IL2 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:37.69cm"><input name=IB3 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:37.69cm"><input name=ID3 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:37.69cm"><input name=IE3 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:37.69cm"><input name=IF3 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:37.78cm"><input name=IH3 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:37.78cm"><input name=II3 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:37.78cm"><input name=IJ3 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:37.78cm"><input name=IL3 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:37.99cm"><input name=IB4 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:37.99cm"><input name=ID4 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:37.99cm"><input name=IE4 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:37.99cm"><input name=IF4 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:38.08cm"><input name=IH4 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:38.08cm"><input name=II4 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:38.08cm"><input name=IJ4 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:38.08cm"><input name=IL4 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:38.29cm"><input name=IB5 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:38.29cm"><input name=ID5 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:38.29cm"><input name=IE5 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:38.29cm"><input name=IF5 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:38.38cm"><input name=IH5 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:38.38cm"><input name=II5 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:38.38cm"><input name=IJ5 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:38.38cm"><input name=IL5 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:38.59cm"><input name=IB6 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:38.59cm"><input name=ID6 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:38.59cm"><input name=IE6 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:38.59cm"><input name=IF6 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:38.68cm"><input name=IH6 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:38.68cm"><input name=II6 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:38.68cm"><input name=IJ6 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:38.68cm"><input name=IL6 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:38.89cm"><input name=IB7 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:38.89cm"><input name=ID7 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:38.89cm"><input name=IE7 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:38.89cm"><input name=IF7 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:38.98cm"><input name=IH7 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:38.98cm"><input name=II7 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:38.98cm"><input name=IJ7 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:38.98cm"><input name=IL7 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top
type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:42.58cm"><input name=IH19 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:42.58cm"><input name=II19 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:42.58cm"><input name=IJ19 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:42.58cm"><input name=IL19 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:42.79cm"><input name=IB20 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:42.79cm"><input name=ID20 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:42.79cm"><input name=IE20 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:42.79cm"><input name=IF20 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:42.88cm"><input name=IH20 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:42.88cm"><input name=II20 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:42.88cm"><input name=IJ20 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:42.88cm"><input name=IL20 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:43.09cm"><input name=IB21 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:43.09cm"><input name=ID21 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:43.09cm"><input name=IE21 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:43.09cm"><input name=IF21 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:43.18cm"><input name=IH21 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:43.18cm"><input name=II21 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:43.18cm"><input name=IJ21 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:43.18cm"><input name=IL21 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:43.39cm"><input name=IB22 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:43.39cm"><input name=ID22 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:43.39cm"><input name=IE22 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:43.39cm"><input name=IF22 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:43.48cm"><input name=IH22 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:43.48cm"><input name=II22 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:43.48cm"><input name=IJ22 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:43.48cm"><input name=IL22 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:43.69cm"><input name=IB23 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:43.69cm"><input name=ID23 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:43.69cm"><input name=IE23 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:43.69cm"><input name=IF23 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:43.78cm"><input name=IH23 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:43.78cm"><input name=II23 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:43.78cm"><input name=IJ23 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:43.78cm"><input name=IL23 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left: 2.18cm; top:43.99cm"><input name=IB24 type=checkbox required></div>
	...
	<div style="position:absolute; left: 4.28cm; top:43.99cm"><input name=ID24 type=checkbox required></div>
	<div style="position:absolute; left: 5.70cm; top:43.99cm"><input name=IE24 type=checkbox required></div>
	<div style="position:absolute; left: 7.00cm; top:43.99cm"><input name=IF24 type=checkbox required></div>
	...
	<div style="position:absolute; left: 9.90cm; top:44.08cm"><input name=IH24 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	<div style="position:absolute; left:12.08cm; top:44.08cm"><input name=II24 type=text style="width:1.00cm; height:0.22cm; text-align:center" maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ title="Debe ingresar mínimo 4 números." value=''></div>
	<div style="position:absolute; left:13.26cm; top:44.08cm"><input name=IJ24 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
	...
	<div style="position:absolute; left:16.93cm; top:44.08cm"><input name=IL24 type=text style="width:2.00cm; height:0.22cm" maxlength=15 pattern=.{1,} onkeyup=mayuscula(this) value=''></div>
...
<!-- *****************************************			 sección K			 ***************************************** -->
	<div style="position:absolute; left: 6.48cm; top:52.36cm"><input name=certificadoK	id=CRTK type=radio value=A onclick=gestionarClickRadio(this) required></div>
	...
	<div style="position:absolute; left: 6.10cm; top:53.23cm"><input name=ejecutorK			type=text	style=width:5cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
<!--	<div style="position:absolute; left:18.90cm; top:53.23cm"><input name=horaejecK			type=time	value=<? echo date("H:i"); ?> required></div> -->
	<div style="position:absolute; left: 6.10cm; top:53.63cm"><input name=inspectorK		type=text	style=width:5cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
<!--	<div style="position:absolute; left:18.90cm; top:53.63cm"><input name=horainspK			type=time	value=<? echo date("H:i"); ?> required></div> -->
	<div style="position:absolute; left: 3.45cm; top:54.53cm"><input name=emisorK				type=text	style=width:5cm maxlength=30 pattern=.{1,} onkeyup=mayuscula(this) value='' required></div>
