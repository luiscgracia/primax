		...
		<table border=0 style="color:black; background-color:<?=$color_formato;?>">
			...
			<tr height=100>
				<td colspan=2>
					...
					<span style="font-size:36px; width:100%; display:inline-block"><b><?=$$formulario; ?></b></span>
				</td>
				<td>
					<input name=consecutivo class=consecutivo style="color:red; background-color:<?=$color_formato;?>; border:0" 
			...
			<tr>
				<td colspan=3>
					<span style=font-size:24px><b>FORMATO WEB - Rev. Mayo 2014 / TERMINAL <?=strtoupper($terminal);?></b></span>
				</td>
			</tr>
		</table>
		<hr>
<!-- *****************************************			 sección A			 ***************************************** -->
		<table border=0>
			...
			<tr height=100px>
				<td>BATCH ECOPETROL No.<br>	<input name=batch_ecopetrol  type=text style=width:50% maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ inputmode=numeric required autofocus></td>
				<td>CARTA LIBERACION No.<br><input name=carta_liberacion type=text style=width:50% maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ inputmode=numeric required></td>
			</tr>
			<tr height=100px>
				<td>FECHA<br>								<input name=fechaA	 type=date value='<?=$hoy;?>' min=<?=$fechamin;?> max=<?=$fechamax;?> required></td>
				<td>DESPACHO No.<br>				<input name=despacho type=text style=width:50% maxlength=6 placeholder=###### pattern=^(?:[0-9]{4,6})$ inputmode=numeric required></td>
			</tr>
		</table>
		<hr>
		...
		<table border=0>
			...
			<tr height=220px>
				<td colspan=2 class=Bc>GRAV. ESPECÍF. CTK AEROP. vs.<br>GRAVEDAD ESPECÍFICA TK DESPACHADOR<br>(debe ser < 0.003 Kgr/l)<br>
					<input name=gravedad_espec_CTK_TK2 type=text style=width:40% maxlength=5 pattern=^((0)(.\d)?(\d)?(\d)?)$ inputmode=numeric required>
				</td>
			</tr>
		</table>
		<hr>
...
<!-- *****************************************			 sección G			 ***************************************** -->
		<table border=0>
			...
			<tr height=130px>
				<td class=Bc>TANQUE RECIBIDOR No.<br>								<input name=TK_recibo_aerop							type=text style=width:40% maxlength=3 pattern=^(?:[0-9]{1,3})$							inputmode=numeric required></td>
				<td class=Bc>MEDIDA INICIAL (mm)<br>								<input name=medida_inicial							type=text style=width:40% maxlength=6 pattern=^(?:[0-9]{1,6})$							inputmode=numeric required></td>
			</tr>
			<tr height=130px>
				<td class=Bc><br>MEDIDA FINAL (mm)<br>							<input name=medida_final								type=text style=width:40% maxlength=6 pattern=^(?:[0-9]{1,6})$							inputmode=numeric required></td>
