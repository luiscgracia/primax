...
<!-- *****************************************			 sección B			 ***************************************** -->
			...
			<div style="position:absolute; width:62.15%; left:37.10%; background-color:white; overflow:scroll">
				...
				echo '<style>
					...
					.i20:focus	{border-color:#ff0000ff; outline:none}
...
<!-- *****************************************			 sección E			 ***************************************** -->
				...
				<table border=0>
					...
					<tr><td></td><td colspan=6 class=B>Se ha retirado a todo el personal del área y esta ha quedado en condiciones de seguridad.	El ingreso al área está ahora prohibido.</td></tr>
					<tr height=30><td></td></tr>
				</table>
				<table border=0>
					<tr><td width=60%></td><td width=21%></td><td width=19%></td></tr>
