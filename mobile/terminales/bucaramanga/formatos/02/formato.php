		...
		<table border=0 style="color:white; background-color:rgba(204,0,0,1)">
			...
			<tr height=100>
				<td colspan=2>
					...
					<span style="font-size:36px; width:661px; display:inline-block; background-color:none"><b><? echo $$formulario; ?></b></span>
				</td>
				<td style=overflow=scroll>
					<input name=consecutivo class=consecutivo style="color:white; background-color:rgba(204,0,0,1); border:0" type=texto
...
<!-- *****************************************			 sección A			 ***************************************** -->
		<table border=0>
			...
			<tr><td>DESCRIPCIÓN DEL TRABAJO<br><textarea name=descripcion maxlength=68 style=width:99% onkeyup=mayuscula(this) pattern=.{1,} required autofocus></textarea></td></tr>
			<tr height=30><td></td></tr>
		</table>
		<table border=0>
			<tr>
				<td width=84% class=Br>PERSONAS AUTORIZADAS PARA EL TRABAJO&nbsp;</td>
				<td style="width:16%; text-align:left"><input style="width:40%; text-align:center" name=cantidad id=cantidad value='' title="Máximo 4 personas" maxlength=1 type=texto inputmode=numeric pattern=[1-4]{1} required></td>
			</tr>
		...
		<table border=0>
			...
			<tr><td></td>
				<td><input name=nombre1 id=nombre1 value="" style=display:none maxlength=30 type=texto placeholder=Nombre&nbsp;1er.&nbsp;autorizado pattern=.{1,} onkeyup=mayuscula(this)></td><td></td>
				<td><input name=nombre2 id=nombre2 value="" style=display:none maxlength=30 type=texto placeholder=Nombre&nbsp;2o.&nbsp;autorizado  pattern=.{1,} onkeyup=mayuscula(this)></td><td></td>
			</tr>
			<tr height=10><td></td></tr>
			<tr><td></td>
				<td><input name=nombre3 id=nombre3 value="" style=display:none maxlength=30 type=texto placeholder=Nombre&nbsp;3er.&nbsp;autorizado pattern=.{1,} onkeyup=mayuscula(this)></td><td></td>
				<td><input name=nombre4 id=nombre4 value="" style=display:none maxlength=30 type=texto placeholder=Nombre&nbsp;4o.&nbsp;autorizado  pattern=.{1,} onkeyup=mayuscula(this)></td><td></td>
			</tr>
	 		<tr height=10><td></td></tr>
		</table>
		<script>
		...
		<table border=0>
			...
			<tr>
				...
				<td class=A>CERTIFICADO<br>HABILITACIÓN<br><input name=certhabilit	class=consecutivo value='' maxlength=6 style=width:67% inputmode=numeric pattern=^(?:[0-9]{4,6})$ required></td>
			</tr>
	 		<tr height=10><td></td></tr>
		</table>
		<hr>
		...
		<table border=0>
			...
			<tr class=C>
				<td colspan=4></td>
				<td class=B><input name=B15b maxlength=36 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
			</tr>
			<tr class=C>
			...
			<tr class=C>
				<td colspan=4></td>
				<td class=B><input name=B18a maxlength=36 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
			</tr>
			<tr class=C>
			...
			<tr class=C>
				<td><input type=radio name=B20 id=B20 value=SI onclick=gestionarClickRadio(this) required></td>
				<td><input type=radio name=B20 id=b20 value=NO onclick=gestionarClickRadio(this)></td>
				<td><input type=radio name=B20 id=v20 value=NA onclick=gestionarClickRadio(this)></td>
				<td class=numero>20.</td><td class=B>Se tienen precauciones para exposición al plomo?</td>
			</tr>
			<tr class=C>
				<td><input type=radio name=B21 id=B21 value=SI onclick=gestionarClickRadio(this) required></td>
				<td><input type=radio name=B21 id=b21 value=NO onclick=gestionarClickRadio(this)></td>
				<td><input type=radio name=B21 id=v21 value=NA onclick=gestionarClickRadio(this)></td>
		...
		<table border=0>
			...
			<tr>
				<td></td>
				<td style=text-align:right class=B>ZAPATOS Tipo&nbsp;</td><td><input name=B12g value="" maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td style=text-align:right class=B>GUANTES Tipo&nbsp;</td><td><input name=B12h value="" maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
			</tr>
			<tr height=10><td></td></tr>
			<tr>
				<td></td>
				<td style=text-align:right class=B>ROPA Tipo&nbsp;</td><td><input name=B12k value="" maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td style=text-align:right class=B>OTRO Tipo&nbsp;</td><td><input name=B12l value="" maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
			</tr>
			<tr height=30><td></td></tr>
		</table>
		<table border=0>
			...
			<tr>
				<td class=A><br>EQUIPO<br>					<input name=B22a value="" maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this) required></td>
				<td class=A><br>MARCA<br>						<input name=B22c value="" maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this) required></td>
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B22e type=date value='<?echo $hoy;?>' required></td>
				<td class=A>BUMP TEST<br>						<input name=B22g type=checkbox></td>
			</tr>
			<tr height=10><td></td></tr>
			<tr>
				<td class=A><br>EQUIPO<br>					<input name=B22b value="" maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td class=A><br>MARCA<br>						<input name=B22d value="" maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B22f type=date value='<?echo $hoy;?>'></td>
				<td class=A>BUMP TEST<br>						<input name=B22h type=checkbox></td>
			</tr>
		</table>
		<br>
...
<!-- 5 --> 	<div style="position:absolute; width:64.45%; left:34.80%; background-color:white; overflow:scroll">
		<table border=1 bordercolor=#ff7000>
			...
			<tr height=70px>
				<td class=A><input name=B22A1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B22B1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
				<td class=A><input name=B22C1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22D1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B22E1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22F1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B22G1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22H1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B22I1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22J1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B22K1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22L1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B22M1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22N1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B22O1 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22P1 type=texto value='' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B22A2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B22B2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric required></td>
				<td class=A><input name=B22C2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22D2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22E2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22F2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22G2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22H2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22I2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22J2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22K2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22L2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22M2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22N2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22O2 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22P2 type=texto value='' id=numero	maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B22A3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B22B3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric required></td>
				<td class=A><input name=B22C3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22D3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B22E3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22F3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B22G3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22H3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B22I3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22J3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B22K3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22L3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B22M3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22N3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B22O3 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22P3 type=texto value='' id=numero	maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B22A4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B22B4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric required></td>
				<td class=A><input name=B22C4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22D4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B22E4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22F4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B22G4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22H4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B22I4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22J4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B22K4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22L4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B22M4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22N4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B22O4 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22P4 type=texto value='' id=numero	maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B22A5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B22B5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric required></td>
				<td class=A><input name=B22C5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22D5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22E5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22F5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22G5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22H5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22I5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22J5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22K5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22L5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22M5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22N5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B22O5 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22P5 type=texto value='' id=numero	maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B22A6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B22B6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric required></td>
				<td class=A><input name=B22C6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22D6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B22E6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22F6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B22G6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22H6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B22I6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22J6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B22K6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22L6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B22M6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22N6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B22O6 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22P6 type=texto value='' id=numero	maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B22A7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B22B7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric required></td>
				<td class=A><input name=B22C7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22D7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B22E7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22F7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B22G7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22H7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B22I7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22J7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B22K7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22L7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B22M7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22N7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B22O7 type=time  value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B22P7 type=texto value='' id=numero	maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
			</tr>
		</table>
<!-- /5 --> 	</div>
...
<!-- 6 --> 	<div style="position:relative; width:100vw; left:0px; top:565px; background-color:rgba(0,0,255,0)">
		<table>
			<tr><td class=A style=text-align:left><b>&nbsp;&nbsp;CONSULTE LA GUÍA DE MEDICIÓN DE GASES AL REVERSO.</b></td></tr>
...
<!-- 8 --> 	<div style="position:relative; width:59%; left:0.50%; top:580px; background-color:white">
		<table border=1>
			...
			<tr height= 50><td class=A1><input name=B231 value="" maxlength=30 type=texto pattern=.{1,} onkeyup=mayuscula(this) required></td></tr>
...
<!-- 9 --> 	<div style="position:relative; width:39.75%; left:59.50%; top:218.50px; background-color:white; overflow:scroll">
		<table border=1 bordercolor=#ff7000>
			...
			<tr height=50>
				<td class=A><input name=B23A1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B23B1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B23C1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23D1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23E1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23F1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23G1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23H1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23I1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23J1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23K1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23L1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23M1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23N1 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
			</tr>
			<tr height=50>
				<td class=A><input name=B23A2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23B2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23C2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23D2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23E2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23F2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23G2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23H2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23I2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23J2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23K2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23L2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23M2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23N2 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
			</tr>
			<tr height=50>
				<td class=A><input name=B23A3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23B3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23C3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23D3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23E3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23F3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23G3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23H3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23I3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23J3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23K3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23L3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23M3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23N3 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
			</tr>
			<tr height=50>
				<td class=A><input name=B23A4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23B4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23C4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23D4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23E4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23F4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23G4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23H4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23I4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23J4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23K4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23L4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23M4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23N4 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
			</tr>
			<tr height=50>
				<td class=A><input name=B23A5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23B5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23C5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23D5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23E5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23F5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23G5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23H5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23I5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23J5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23K5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23L5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23M5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B23N5 type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
			</tr>
		</table>
<!-- /9 --> 	</div>
...
<!-- 10 --> 		<div style="position:relative; left:0; width:100vw; top:220"> <!-- este div mueve hacia abajo desde la sección C -->
		...
		<table border=0>
			...
			<tr>
				<td><input name=fechaemisorD	type=date  class=mostrarfecha value='<?echo $fecha_oculta;?>' readonly style=display:none></td>
