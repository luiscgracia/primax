			...
			<table border=0 style="color:white; background-color:rgba(204,0,0,1)">
				...
				<tr>
					<td colspan=3>
						...
						<span style=font-size:18.25px>ADVERTENCIA: EN CASO DE QUE SUENE UNA ALARMA DE EMERGENCIA ESTE CERTIFICADO PIERDE VALIDEZ</span><br>
...
<!-- *****************************************			 sección B			 ***************************************** -->
			<table border=0>
				...
				<tr class=C><td colspan=4></td><td class=B><input name=B15b maxlength=36 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td></tr>
				...
				<tr class=C><td colspan=4></td><td class=B><input name=B18a maxlength=36 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td></tr>
				...
				foreach ($security3Questions as $num => $question) {
					echo "<tr class='C'>
						<td><input type='radio' id='B{$num}' name='B{$num}' value='SI' onclick='handleRadioClick(this)' required></td>
						<td><input type='radio' id='b{$num}' name='B{$num}' value='NO' onclick='handleRadioClick(this)'></td>
						<td><input type='radio' id='v{$num}' name='B{$num}' value='NA' onclick='handleRadioClick(this)'></td>
		...
		<table border=0>
			...
			<tr>
				...
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B22e type=date value=<?echo $fechacero;?> max=<?echo $fechaactual;?> required></td>
			...
			<tr>
				...
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B22f type=date value=<?echo $fechacero;?> max=<?echo $fechaactual;?>></td>
			...
			echo '<table class=tabla22>
				...
				echo '<tr>';
					for($j = 0; $j < $columnas; $j++) {
						...
						echo "<td><input name=B22{$l[$j*2]}".($i+1)." 	type=time class='$class22' $q22></td>";
				...
				<tr>
					<td class=A style=text-align:left>
						<b>&nbsp;CONSULTE LA GUÍA DE MEDICIÓN DE GASES AL REVERSO.<br>
							 ...
							 &nbsp;SI EL %LEL SE SUBE DE 0%, SUSPENDA EL TRABAJO INMEDIATAMENTE.</b>
					</td>
				</tr>
			</table>
		</div>
...
<!-- 10 --> 		<div style="position:relative; left:0; width:100vw; top:255"> <!-- este div mueve hacia abajo desde la sección C -->
		...
		<table border=0>
			...
			<tr>
				<td><input name=fechaemisorD	type=date	class=mostrarfecha value=<?echo $fechahoy;?> min=<?echo $fechamin;?> max=<?echo $fechamax;?> readonly style=display:none></td>
