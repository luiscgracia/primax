...
<!-- *****************************************			 sección A			 ***************************************** -->
		...
		<table border=0>
			...
			<tr>
				<td><input name=tanque id=tanque type=text style=width:96% onkeyup="mayuscula(this); t()" maxlength=7 pattern=.{1,} autofocus required></td>
				<td>
					<form method=post>
		...
		<table border=0>
			...
			<tr>
				...
				<td style=text-align:left	><input name=hora_inicial  type=time value='<?=$hora;?>' min=<?=$horamin;?> required></td>
				<td style=text-align:left	></td>
			</tr>
			<tr>
				<td style=text-align:right>HORA FINAL ESTIMADA&nbsp;</td>
				<td style=text-align:left	><input name=hora_final  type=time value='<?=$hora;?>' min=<?=$horamin;?> required></td>
				<td style=text-align:left	></td>
			</tr>
			<tr>
...
<!-- hasta aquí va la tirilla media carta -->
		...
		<table border=1>
			...
			<tr>
				...
				<td colspan=2 rowspan=2>TEMPERATURA °F</td>
			</tr>
			<tr>
				<td>MEDIDA</td>
			...
			<tr>
				<td>1</td>
				<td><input name=nivel11_mt	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel11_cm	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel11_mm	type=text style=width:90% maxlength=1 placeholder=#  pattern=^([0-9]{1}?)$	 inputmode=numeric required></td>
				<td>Baja</td>
				<td><input name=temperatura1_baja	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td>2</td>
				<td><input name=nivel12_mt	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel12_cm	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel12_mm	type=text style=width:90% maxlength=1 placeholder=#  pattern=^([0-9]{1}?)$	 inputmode=numeric required></td>
				<td>Media</td>
				<td><input name=temperatura1_media	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td>3</td>
				<td><input name=nivel13_mt	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel13_cm	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel13_mm	type=text style=width:90% maxlength=1 placeholder=#  pattern=^([0-9]{1}?)$	 inputmode=numeric required></td>
				<td>Alta</td>
				<td><input name=temperatura1_alta	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td>AGUA</td>
				...
				<td>Promedio</td>
				<td><input name=temperatura1_promedio	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
		</table>
		<table border=0>
			<tr>
		...
		<table border=1>
			...
			<tr>
				<td colspan=7>ALTURA DE REFERENCIA (BM)</td>
			</tr>
			<tr>
				<td colspan=3>MEDIDA</td>
				<td colspan=3>TABLA DE AFORO</td>
				<td rowspan=2 style=font-size:23px>DIFERENCIA ALTURA REFERENCIA</td>
			</tr>
			<tr>
				<td>m</td><td>cm</td><td>mm</td>
				<td>m</td><td>cm</td><td>mm</td>
			...
			<tr>
				<td><input name=referencia1_medida_mt type=text style=width:90% maxlength=2 placeholder=## 		pattern=^([0-9]{1,2}?)$ required></td>
				<td><input name=referencia1_medida_cm type=text style=width:90% maxlength=2 placeholder=##		pattern=^([0-9]{1,2}?)$ required></td>
				<td><input name=referencia1_medida_mm type=text style=width:90% maxlength=1 placeholder=#  		pattern=^([0-9]{1}?)$	 required></td>
				<td><input name=referencia1_aforo_mt  type=text style=width:90% maxlength=2 placeholder=## 		pattern=^([0-9]{1,2}?)$ required></td>
				<td><input name=referencia1_aforo_cm  type=text style=width:90% maxlength=2 placeholder=## 		pattern=^([0-9]{1,2}?)$ required></td>
				<td><input name=referencia1_aforo_mm  type=text style=width:90% maxlength=1 placeholder=#  		pattern=^([0-9]{1}?)$	 required></td>
				<td><input name=dif_alt_referencia1   type=text style=width:90% maxlength=5 placeholder=##.## pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ required></td>
			</tr>
		</table>
		<hr>
		...
		<table border=0>
			...
			<tr><td colspan=6 class=A0>MEDICIÓN MANUAL FINAL</td></tr>
			<tr>
				<td class=Aright>SI</td><td><input name=tiempo_reposo	type=radio value=SIrequired></td>
				<td class=Aright><!--NO--></td><td><!--<input name=tiempo_reposo	type=radio value=NO--></td>
				<td></td><td class=Aleft>DESPUÉS DE LA FINALIZACIÓN DEL BOMBEO, SE HA ESPERADO EL TIEMPO DE REPOSO ESTABLECIDO EN EL PROCEDIMIENTO PARA MEDIR EL TANQUE?</td>
			</tr>
		</table>
		<table border=0>
			<tr>
		...
		<table border=1>
			...
			<tr>
				<td>1</td>
				<td><input name=nivel21_mt	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel21_cm	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel21_mm	type=text style=width:90% maxlength=1 placeholder=#	 pattern=^([0-9]{1}?)$	 inputmode=numeric required></td>
				<td>Baja</td>
				<td><input name=temperatura2_baja	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td>2</td>
				<td><input name=nivel22_mt	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel22_cm	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel22_mm	type=text style=width:90% maxlength=1 placeholder=#	 pattern=^([0-9]{1}?)$	 inputmode=numeric required></td>
				<td>Media</td>
				<td><input name=temperatura2_media	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td>3</td>
				<td><input name=nivel23_mt	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel23_cm	type=text style=width:90% maxlength=2 placeholder=## pattern=^([0-9]{1,2}?)$ inputmode=numeric required></td>
				<td><input name=nivel23_mm	type=text style=width:90% maxlength=1 placeholder=#	 pattern=^([0-9]{1}?)$	 inputmode=numeric required></td>
				<td>Alta</td>
				<td><input name=temperatura2_alta	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td>AGUA</td>
				...
				<td>Promedio</td>
				<td><input name=temperatura2_promedio	type=text style=width:90% maxlength=6 placeholder=###.## pattern=^([0-9]{1,3}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
			</tr>
		</table>
		<table border=1>
			<tr>
			...
			<tr><td colspan=7>ALTURA DE REFERENCIA (BM)</td></tr>
			<tr>
				<td colspan=3>MEDIDA</td>
				<td colspan=3>TABLA DE AFORO</td>
				<td rowspan=2 style=font-size:23px>DIFERENCIA ALTURA REFERENCIA</td>
			...
			<tr>
				<td><input name=referencia2_manual_mt type=text style=width:90% maxlength=2 placeholder=##		pattern=^([0-9]{1,2}?)$	inputmode=numeric required></td>
				<td><input name=referencia2_manual_cm type=text style=width:90% maxlength=2 placeholder=##		pattern=^([0-9]{1,2}?)$	inputmode=numeric required></td>
				<td><input name=referencia2_manual_mm type=text style=width:90% maxlength=1 placeholder=#			pattern=^([0-9]{1}?)$		inputmode=numeric required></td>
				<td><input name=referencia2_aforo_mt  type=text style=width:90% maxlength=2 placeholder=##		pattern=^([0-9]{1,2}?)$	inputmode=numeric required></td>
				<td><input name=referencia2_aforo_cm  type=text style=width:90% maxlength=2 placeholder=##		pattern=^([0-9]{1,2}?)$	inputmode=numeric required></td>
				<td><input name=referencia2_aforo_mm  type=text style=width:90% maxlength=1 placeholder=#			pattern=^([0-9]{1}?)$		inputmode=numeric required></td>
				<td><input name=dif_alt_referencia2   type=text style=width:90% maxlength=5 placeholder=##.##	pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ required></td>
			</tr>
		</table>
		<table border=1>
			<tr>
		...
		<table border=0>
			...
			<tr><td colspan=4 class=A0>LIQUIDACIÓN FINAL DE VOLUMEN RECIBIDO<br>MEDICIÓN MANUAL</td></tr>
			<tr>
