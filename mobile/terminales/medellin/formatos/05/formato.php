...
<!-- *****************************************			 sección A			 ***************************************** -->
		...
		<table border=0>
			...
			foreach ($Questions2 as $num => $question) {
				echo "<tr class='C'>
					<td><input type='radio' id='B{$num}' name='B{$num}' value='SI' onclick='handleRadioClick(this)' required></td>
					<td><input type='radio' id='b{$num}' name='B{$num}' value='NO' onclick='handleRadioClick(this)'></td>
					<td><input type='radio' id='v{$num}' name='B{$num}' value='NA' onclick='handleRadioClick(this)'></td>
			...
			?>
			<tr class=C><td colspan=4></td><td class=B><textarea name=especifiqueB10b maxlength=85 style=width:99% onkeyup=mayuscula(this) pattern=.{1,}></textarea></td></tr>
		</table>
		...
		<table border=0>
			...
			<tr>
				...
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B12fecha  type=date value=<?echo $fechacero;?> max=<?echo $fechaactual;?>></td>
