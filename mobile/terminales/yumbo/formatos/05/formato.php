			...
			<table border=0 style="color:white; background-color:<?=$color_formato;?>">
				...
				<tr height=100>
					<td colspan=2>
						...
						<span style="font-size:36px; width:570px; display:inline-block"><b><?=$$formulario;?></b></span>
					</td>
					<td>
...
<!-- *****************************************			 sección B			 ***************************************** -->
			<table border=1>
				...
				$ap = '50px';
				$preguntas1 = [
					 1 => "Está el área limpía y libre de sustancias combustibles o tóxicas?",
					 2 => "Están los desagües cercanos Cubiertos y Sellados?",
					 3 => "Permiten los factores externos efectuar el trabajo con Seguridad?<br><span>(Dirección Viento, Condiciones Atmosféricas, Trabajos vecinos)</span>",
					 4 => "Se ha identificado y demarcado adecuadamente el Área Bajo Control?",
					 5 => "Se necesita documentación adicional? Indique:"
				];
				...
				$preguntas2 = [
					 ...
					 8 => "Se requiere inspector de Seguridad?",
					 9 => "Está disponible y listo el equipo de Primeros Auxilios?",
					10 => "Está disponible y listo el Equipo Contra Incendios? Especifique:"
				];
			...
			<table border=0>
				...
				<tr><td colspan=8 class=B style=border:0px>&nbsp;&nbsp;11. ELEMENTOS DE PROTECCIÓN</td></tr>
				<tr>
					<td></td>
			...
			<table border=0>
				...
				<tr>
					<td></td>
					<td style=text-align:right class=B>Otro 1 <input name=B11m type=checkbox onChange=comprobarB11m(this)></td>
					<td><input style=display:none name=otro1 id=otro1 maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
					<td></td>
					<td style=text-align:right class=B>Otro 2 <input name=B11n type=checkbox onChange=comprobarB11n(this)></td>
				...
				<tr>
					<td></td>
					<td style=text-align:right class=B>Otro 3 <input name=B11o type=checkbox onChange=comprobarB11o(this)></td>
			...
			<table border=0>
				...
				<tr><td colspan=4 class=B>&nbsp;&nbsp;12. PRUEBA DE GASES</td></tr>
				<tr>
					<td colspan=3>
						<table border=0>
