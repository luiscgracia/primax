...
<style type="text/css">
	...
	.contenido	{position:relative; width:100%; top:215px; left:0px; z-index:9; margin-top:0px; margin-right:0px; margin-bottom:0px; margin-left:0px;
	...
	.titulo_sin	{border-top:solid white 0px; border-right:solid white 1px; border-bottom:solid white 0px; border-left:solid white 1px;
							 background-color:rgba(255,115,0,0,5); color:rgba(40,40,40,1); font-size:20px; font-family:Arlrdbd; text-align:center}
</style>
<script>
...
<div class='encabezado'>
	<table style='width:100%; margin-left:auto; margin-right:auto' border='0' cellpadding='0' cellspacing='0'>
		<tr height='0px'>
			<td class='titulo' style='width:20%; background-color:rgba(0,0,0,1)''></td>
			<td class='titulo' style='width:25%; background-color:rgba(0,0,0,1)''></td>
			<td class='titulo' style='width:55%; background-color:rgba(0,0,0,1)''></td>
		</tr>
		<tr height='70px'>
			<td colspan='3' style='font-size:30px; color:rgba(0,0,0,1); background-color:rgba(255,112,0,1)'>TERMINAL "; echo strtoupper($terminal); echo "</td>
		</tr>
		<tr height='80px'>
			<td colspan='3' style='font-size:26px; color:white; background-color:rgba(0,0,0,1)'>"; echo $$formulario; echo "</td>
		</tr>
		<tr height='55px'>
...
<div class='contenido'>
	...
	<tr height='70px'>"."
		<td style='width:20%; font-size:32px; font-family:SCHLBKB; color:red; text-align:center'>".$cons."</td>
		<td style='width:25%; font-size:32px; color:black; text-align:center'>".$formato['estado']."</td>
		<td style='width:55%; font-size:32px; color:black; text-align:center'>".$formato['fecha']."</td>
	</tr>";}
echo "
	</table>
	<br>
