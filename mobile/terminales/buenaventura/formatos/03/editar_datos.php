...
<!-- *****************************************			 sección A			 ***************************************** -->
		<table border=0>
			...
			<tr><td>DESCRIPCIÓN DEL TRABAJO<textarea name=descripcion maxlength=80 style=width:99% onkeyup=mayuscula(this) pattern=.{1,} required autofocus>$row[descripcion]</textarea></td></tr>
		...
		<table border=0>
			...
			<tr class=C>
				<td colspan=3></td>
				<td colspan=2 class=B><textarea name=indiqueB7b maxlength=85 style=width:99% pattern=.{1,} onkeyup=mayuscula(this)>$row[indiqueB7b]</textarea></td>
			</tr>
			<tr class=C>
			...
			<tr class=C>
				<td colspan=3></td>
				<td colspan=2 class=B><textarea name=especifiqueB11b maxlength=85 style=width:99% pattern=.{1,} onkeyup=mayuscula(this)>$row[especifiqueB11b]</textarea></td>
			</tr>
	 		<tr height=10><td></td></tr>
		</table>
		<table border=0>
			...
			<tr>
				...
				<td><input name=B12d type=checkbox "; if ($row['B12d'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;PROTECCIÓN<br> &nbsp;RESPIRATORIA</td>
				<td></td>
			</tr>
			<tr><td height=30></td></tr>
			<tr>
				<td></td>
				<td><input name=B12e type=checkbox "; if ($row['B12e'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;PROTECCIÓN<br> &nbsp;AUDITIVA</td>
				<td><input name=B12g type=checkbox "; if ($row['B12g'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;PROTECCIÓN<br> &nbsp;FACIAL</td>
				<td><input name=B12h type=checkbox "; if ($row['B12h'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;ANTEOJOS DE<br> &nbsp;SEGURIDAD</td>
				<td></td>
			</tr>
			<tr><td height=30></td></tr>
			<tr>
				<td></td>
				<td><input name=B12f type=checkbox "; if ($row['B12f'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;ARNÉS DE<br> &nbsp;SEGURIDAD</td>
				<td><input name=B12c type=checkbox "; if ($row['B12c'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;SALVAVIDAS</td>
				<td></td><td class=B></td>
				<td></td>
			</tr>
			<tr height=30><td></td></tr>
		...
		<table border=0>
			...
			<tr>
				<td></td>
				<td style=text-align:right class=B>GUANTES <input name=B12i type=checkbox "; if ($row['B12i'] == 'on') {echo 'checked';} echo " onChange=comprobarB12i(this)></td>
				<td>
					<input name='guante' id='guante' value='"; if ($row['B12i'] == 'on') {echo $row['guante'];} else {echo '';} echo "'
					style='width:100%; "; if ($row['B12i'] != 'on') {echo 'display:none';} echo "' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)>
				</td>
				<td></td>
				<td style=text-align:right class=B>CALZADO <input name=B12j type=checkbox "; if ($row['B12j'] == 'on') {echo 'checked';} echo " onChange=comprobarB12j(this)></td>
				<td>
					<input name='calzado' id='calzado' value='"; if ($row['B12j'] == 'on') {echo $row['calzado'];} else {echo '';} echo "'
					style='width:100%; "; if ($row['B12j'] != 'on') {echo 'display:none';} echo "' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)>
				</td>
				<td></td>
			</tr>
	 		<tr height=10><td></td></tr>
			<tr>
				<td></td>
				<td style=text-align:right class=B>DELANTAL <input name=B12k type=checkbox "; if ($row['B12k'] == 'on') {echo 'checked';} echo " onChange=comprobarB12k(this)></td>
				<td>
					<input name='delantal' id='delantal' value='"; if ($row['B12k'] == 'on') {echo $row['delantal'];} else {echo '';} echo "'
					style='width:100%; "; if ($row['B12k'] != 'on') {echo 'display:none';} echo "' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)>
				</td>
				<td></td>
				<td style=text-align:right class=B>ROPA <input name=B12l type=checkbox "; if ($row['B12l'] == 'on') {echo 'checked';} echo " onChange=comprobarB12l(this)></td>
				<td>
					<input name='ropa' id='ropa' value='"; if ($row['B12l'] == 'on') {echo $row['ropa'];} else {echo '';} echo "'
					style='width:100%; "; if ($row['B12l'] != 'on') {echo 'display:none';} echo "' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)>
				</td>
				<td></td>
			</tr>
	 		<tr height=10><td></td></tr>
			<tr>
				<td></td>
				<td style=text-align:right class=B>Otro 1 <input name=B12m type=checkbox "; if ($row['B12m'] == 'on') {echo 'checked';} echo " onChange=comprobarB12m(this)></td>
				<td>
					<input name='otro1' id='otro1' value='"; if ($row['B12m'] == 'on') {echo $row['otro1'];} else {echo '';} echo "'
					style='width:100%; "; if ($row['B12m'] != 'on') {echo 'display:none';} echo "' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)>
				</td>
				<td></td>
				<td style=text-align:right class=B>Otro 2 <input name=B12n type=checkbox "; if ($row['B12n'] == 'on') {echo 'checked';} echo " onChange=comprobarB12n(this)></td>
				<td>
					<input name='otro2' id='otro2' value='"; if ($row['B12n'] == 'on') {echo $row['otro2'];} else {echo '';} echo "'
					style='width:100%; "; if ($row['B12n'] != 'on') {echo 'display:none';} echo "' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)>
				</td>
				<td></td>
			</tr>
	 		<tr height=10><td></td></tr>
			<tr>
				<td></td>
				<td style=text-align:right class=B>Otro 3 <input name=B12o type=checkbox "; if ($row['B12o'] == 'on') {echo 'checked';} echo " onChange=comprobarB12o(this)></td>
				<td>
					<input name='otro3' id='otro3' value='"; if ($row['B12o'] == 'on') {echo $row['otro3'];} else {echo '';} echo "'
					style='width:100%; "; if ($row['B12o'] != 'on') {echo 'display:none';} echo "' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)>
				</td>
				<td></td>
				<td></td>
				<td></td>
		...
		<table border=0>
			...
			<tr><td colspan=3 style=text-align:left class=B>&nbsp;&nbsp;13. PRUEBA DE GASES</td></tr>
			<tr>
				<td colspan=3>
					<table border=0>
			...
			<tr height=30><td></td></tr>
			<tr>
				<td class=A><br>EQUIPO<br>					<input name=B13equipo		value='$row[B13equipo]' type=texto maxlength=15 pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td class=A><br>DUEÑO<br>						<input name=B13dueno		value='$row[B13dueno]'  type=texto maxlength=15 pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B13fecha 		type=date  value='$row[B13fecha]' min='$row[B13fecha]' max='$row[B13fecha]'></td>
				<td class=A>BUMP<br>TEST<br>				<input name=B13bumptest type=checkbox "; if ($row['B13bumptest'] == 'on') {echo 'checked';} echo "></td>
			</tr>
			<tr height=30><td></td></tr>
		</table>
...
<!-- 5 --> 		<div style='position:absolute; width:77.05%; left:22.20%; background-color:white; overflow:scroll'>
		<table border=1 bordercolor=#ff7000>
			...
			<tr height=70px>
				<td class=A><input name=B13hora1	type=time  value='$row[B13hora1]' required></td>
				<td class=A><input name=B13resul1 type=texto value='$row[B13resul1]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
				<td class=A><input name=B13hora2	type=time  value='$row[B13hora2]'</td>
				<td class=A><input name=B13resul2 type=texto value='$row[B13resul2]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora3	type=time  value='$row[B13hora3]'</td>
				<td class=A><input name=B13resul3 type=texto value='$row[B13resul3]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora4	type=time  value='$row[B13hora4]'</td>
				<td class=A><input name=B13resul4 type=texto value='$row[B13resul4]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora5	type=time  value='$row[B13hora5]'</td>
				<td class=A><input name=B13resul5 type=texto value='$row[B13resul5]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora6	type=time  value='$row[B13hora6]'</td>
				<td class=A><input name=B13resul6 type=texto value='$row[B13resul6]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora7	type=time  value='$row[B13hora7]'</td>
				<td class=A><input name=B13resul7 type=texto value='$row[B13resul7]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora8	type=time  value='$row[B13hora8]'</td>
				<td class=A><input name=B13resul8 type=texto value='$row[B13resul8]' id=numero value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
			</tr>
		</table>
<!-- /5 --> 		</div>
<!-- 6 --> 		<div style='width:100vw; position:relative; top:160px; left:0px'>
			<table border=0>
				<tr><td class=A style=text-align:left><span><b>&nbsp;SI EL %LEL SE SUBE DE 0%, SUSPENDA EL TRABAJO INMEDIATAMENTE</b></span></td></tr>
			</table>
<!-- /6 --> 		</div>
