...
<!-- 3 -->		<div style="position:absolute; left:50vw; margin-left:-50vw; top:0px; width:100vw">
		...
		<table>
			...
			<tr>
				<td class=A1><br>CAPACIDAD MÁXIMA OPERACIONAL<input name=capacidad type=text style="width:50%; text-align:center" maxlength=8 pattern=^(([0-9]){1,5}?(.\d)?(\d)?)$ required></td>
		...
		<table border=1>
			<tr>
				...
				<td style="width:18.0%; border:0"></td>
				<td style="width:18.0%; border:0"></td>
				<td style="width:11.3%; border:0"></td>
			</tr>
			<tr>
				<td class=A1></td>
...
<!-- hasta aquí va la tirilla media carta -->
		...
		<table border=1>
			...
			<tr>
				<td class=A>1</td>
				<td class=A><input name=nivel11_mt	type=text style="width:98%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel11_cm	type=text style="width:98%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel11_mm	type=text style="width:98%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td class=A>Baja</td>
				<td class=A><input name=temperatura1_baja	type=text style="width:98%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>2</td>
				<td class=A><input name=nivel12_mt	type=text style="width:98%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel12_cm	type=text style="width:98%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel12_mm	type=text style="width:98%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td class=A>Media</td>
				<td class=A><input name=temperatura1_media	type=text style="width:98%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>3</td>
				<td class=A><input name=nivel13_mt	type=text style="width:98%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel13_cm	type=text style="width:98%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel13_mm	type=text style="width:98%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td class=A>Alta</td>
				<td class=A><input name=temperatura1_alta	type=text style="width:98%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>AGUA</td>
				<td class=A><input name=agua1_mt		type=text style="width:98%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=agua1_cm		type=text style="width:98%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=agua1_mm		type=text style="width:98%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td class=A>Promedio</td>
				<td class=A><input name=temperatura1_promedio	type=text style="width:98%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
		</table>
		<table border=0>
			<tr>
		...
		<table border=1>
			...
			<tr>
				...
				<td rowspan=2 class=A><span style="font-size:23px">DIFERENCIA ALTURA REFERENCIA</span></td>
			</tr>
			<tr>
			...
			<tr>
				<td class=A><input name=referencia1_medida_mt type=text style="width:100%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ required></td>
				<td class=A><input name=referencia1_medida_cm type=text style="width:100%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ required></td>
				<td class=A><input name=referencia1_medida_mm type=text style="width:100%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ required></td>
				<td class=A><input name=referencia1_aforo_mt  type=text style="width:100%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ required></td>
				<td class=A><input name=referencia1_aforo_cm  type=text style="width:100%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ required></td>
				<td class=A><input name=referencia1_aforo_mm  type=text style="width:100%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ required></td>
				<td class=A><input name=dif_alt_referencia1   type=text style="width:100%; text-align:center" maxlength=3 pattern=^(?:[0-9]{0,3})$ required></td>
			</tr>
		</table>
		<hr>
		...
		<table border=0>
			...
			<tr>
				...
				<td class=A><input name=tiempo_reposo	type=radio value=SIrequired></td>
		...
		<table border=0>
			...
			<tr>
				<td class=Aright>SI&nbsp;</td><td><input name=tanque_drenaje2	type=radio value=SI required></td>
				<td class=Aright>NO&nbsp;</td><td><input name=tanque_drenaje2 type=radio value=NO></td>
				<td class=Aright>NA&nbsp;</td><td><input name=tanque_drenaje2 type=radio value=NA></td>
				<td class=Aleft>&nbsp;&nbsp;EL TANQUE DE DRENAJE QUEDÓ VACÍO?</td>
			</tr>
			<tr height=10px><td></td>
		</table>
		<table border=1>
			...
			<tr>
				<td class=A>1</td>
				<td class=A><input name=nivel21_mt	type=text style="width:90%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel21_cm	type=text style="width:90%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel21_mm	type=text style="width:90%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td class=A>Baja</td>
				<td class=A><input name=temperatura2_baja	type=text style="width:90%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>2</td>
				<td class=A><input name=nivel22_mt	type=text style="width:90%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel22_cm	type=text style="width:90%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel22_mm	type=text style="width:90%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td class=A>Media</td>
				<td class=A><input name=temperatura2_media	type=text style="width:90%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>3</td>
				<td class=A><input name=nivel23_mt	type=text style="width:90%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel23_cm	type=text style="width:90%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel23_mm	type=text style="width:90%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td class=A>Alta</td>
				<td class=A><input name=temperatura2_alta	type=text style="width:90%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>AGUA</td>
				...
				<td class=A>Promedio</td>
				<td class=A><input name=temperatura2_promedio	type=text style="width:90%; text-align:center" maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
		</table>
		<table border=1>
			<tr>
			...
			<tr>
				<td class=A><input name=referencia2_manual_mt type=text style="width:90%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ required></td>
				<td class=A><input name=referencia2_manual_cm type=text style="width:90%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ required></td>
				<td class=A><input name=referencia2_manual_mm type=text style="width:90%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ required></td>
				<td class=A><input name=referencia2_aforo_mt  type=text style="width:90%; text-align:center" maxlength=3 pattern=^(?:[0-9]{1,3})$ required></td>
				<td class=A><input name=referencia2_aforo_cm  type=text style="width:90%; text-align:center" maxlength=2 pattern=^(?:[0-9]{0,2})$ required></td>
				<td class=A><input name=referencia2_aforo_mm  type=text style="width:90%; text-align:center" maxlength=1 pattern=^(?:[0-9]{0,1})$ required></td>
				<td class=A><input name=dif_alt_referencia2   type=text style="width:90%; text-align:center" maxlength=3 pattern=^(?:[0-9]{0,3})$ required></td>
			</tr>
		</table>
		<table border=1>
			<tr>
		...
		<table>
			...
			<tr><td><textarea name=observaciones type=text style=width:99% maxlength=500 onkeyup=mayuscula(this) pattern=.{1,} required></textarea></td></tr>
		</table>
		<hr>
		...
		<table border=0>
			...
			<tr>
				...
				<td class=A><input name=inicial5 id=inicial5 	type=text style="width:100%; background-color:rgba(0,0,0,0); border:0" readonly></td>
				<td class=A><input name=final5 id=final5 	type=text style="width:100%; background-color:rgba(0,0,0,0); border:0" readonly></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class=A><input name=inicial9 id=inicial9 	type=text style="width:100%; background-color:rgba(0,0,0,0); border:0" readonly></td>
				<td class=A><input name=final9 id=final9 	type=text style="width:100%; background-color:rgba(0,0,0,0); border:0" readonly></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan=5 class=Aleft><span style="font-size:23.48px">14. VOLUMEN NETO ENTREGADO POR CONTADORES (11x13)</span></td>
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A><input name=final14 id=final14 	type=text style="width:100%; background-color:rgba(0,0,0,0); border:0" readonly></td>
			</tr>
			<tr>
				<td colspan=5 class=Aleft>15. VOLUMEN NETO RECIBIDO (10+14)</td>
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A><input name=final15 id=final15 	type=text style="width:100%; background-color:rgba(0,0,0,0); border:0" readonly></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A><input name=final17 id=final17 	type=text style="width:100%; background-color:rgba(0,0,0,0); border:0" readonly></td>
			</tr>
			<tr>
				<td colspan=5 class=Aleft>18. PORCENTAJE DE VARIACION (17/16 x 100)</td>
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A>
					<input name=final18	id=final18	type=text style="width:70%; text-align:right; background-color:rgba(0,0,0,0); border:0" readonly><span style="font-size:24px; color:rgba(0,0,191,1); background-color:rgba(0,0,0,0)">%</span>
				</td>
			</tr>
