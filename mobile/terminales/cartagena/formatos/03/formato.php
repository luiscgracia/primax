...
<!-- 3 --> 	<div style="position:absolute; left:50vw; margin-left:-50vw; top:0px; width:100vw">
		<table border=0 style="color:white; background-color:rgba(255,0,0,1)">
			...
			<tr height=100>
				...
				<td>
					<input name=consecutivo class=consecutivo style="color:white; background-color:rgba(255,0,0,1); border:0" type=textoo
...
<!-- *****************************************			 sección A			 ***************************************** -->
		...
		<!-- *****************************************			 sección B			 ***************************************** -->
		<table border=0>
			<tr><td width= 5vw></td><td width= 5vw></td><td width= 5vw></td><td width= 7vw></td><td width=78vw></td></tr>
		...
		<table border=0>
			<tr>
				<td width= 1.00vw></td>
				<td width=24.75vw></td><td width=23.75vw></td>
				<td width= 1.00vw></td>
				<td width=24.75vw></td><td width=23.75vw></td>
				<td width= 1.00vw></td>
			<tr>
			<tr>
				...
				<td><input style="display:none; width:100%" name=guante id=guante maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td style="text-align:right" class=B>CALZADO <input name=B12j type=checkbox onChange=comprobarB11j(this)></td>
				<td><input style="display:none; width:100%" name=calzado id=calzado maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
			</tr>
	 		<tr height=10><td></td></tr>
			<tr>
				...
				<td><input style="display:none; width:100%" name=delantal id=delantal maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td style="text-align:right" class=B>ROPA <input name=B12l type=checkbox onChange=comprobarB11l(this)></td>
				<td><input style="display:none; width:100%" name=ropa id=ropa maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
			</tr>
	 		<tr height=10><td></td></tr>
			<tr>
				...
				<td><input style="display:none; width:100%" name=otro1 id=otro1 maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td style="text-align:right" class=B>Otro 2 <input name=B12n type=checkbox onChange=comprobarB11n(this)></td>
				<td><input style="display:none; width:100%" name=otro2 id=otro2 maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
			</tr>
	 		<tr height=10><td></td></tr>
			<tr>
				...
				<td><input style="display:none; width:100%" name=otro3 id=otro3 maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td></td>
				<td></td>
				<td></td>
...
<!-- 5 --> 		<div style="position:absolute; width:80.25%; left:19%; background-color:white; overflow:scroll">
		<table border=1 bordercolor=#ff7000>
			<tr height=70px>
				<td style=width:170px class=A2>Hora<br>1</td><td style=width:132px class=A2>Resultado<br>1</td>
				<td style=width:170px class=A2>Hora<br>2</td><td style=width:132px class=A2>Resultado<br>2</td>
				<td style=width:170px class=A2>Hora<br>3</td><td style=width:132px class=A2>Resultado<br>3</td>
				<td style=width:170px class=A2>Hora<br>4</td><td style=width:132px class=A2>Resultado<br>4</td>
				<td style=width:170px class=A2>Hora<br>5</td><td style=width:132px class=A2>Resultado<br>5</td>
				<td style=width:170px class=A2>Hora<br>6</td><td style=width:132px class=A2>Resultado<br>6</td>
				<td style=width:170px class=A2>Hora<br>7</td><td style=width:132px class=A2>Resultado<br>7</td>
				<td style=width:170px class=A2>Hora<br>8</td><td style=width:132px class=A2>Resultado<br>8</td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B13hora1	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?> required></td>
				<td class=A><input name=B13resul1 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
				<td class=A><input name=B13hora2	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B13resul2 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora3	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B13resul3 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora4	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B13resul4 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora5	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B13resul5 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora6	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B13resul6 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora7	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B13resul7 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B13hora8	id=hora		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?>></td>
				<td class=A><input name=B13resul8 id=numero	type=texto value='' maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
			</tr>
		</table>
<!-- /5 --> 		</div>
...
<!-- 7 --> 		<div style="position:relative; left:0px; width:100vw; top:170px"> <!-- este div mueve hacia abajo desde la sección C -->
		...
		<table border=0>
			...
			<tr>
				...
				<td><input name=horaejecC		type=time value='<?echo $hora;?>' min=<?echo date("H:i");?> required>
			</tr>
		...
		<table border=0>
			...
			<tr>
				<td><input name=fechaemisorD	type=date class=mostrarfecha value=<?echo $fecha_oculta;?> style=display:none></td>
				...
				<td><input name=horaemisorD		type=time class=mostrarhora  value='<?echo $hora;?>' min=<?echo date("H:i");?> style=display:none></td>
			</tr>
			<tr>
		...
		<table border=0>
			...
			<tr><td class=Bct>&nbsp;&nbsp;&#9679;&nbsp;</td><td class=B colspan=3>Certifico que el Trabajo mencionado en la Sección A:</td></tr>
		</table>
		<table border=0>
			<tr>
				<td style=width:5%></td>
