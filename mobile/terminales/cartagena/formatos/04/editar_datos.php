...
<form name=formato id=formato method=post action=grabardatos.php enctype=application_x-www-form-urlencoded autocomplete=off>
	<div style='position:absolute; left:50vw; margin-left:-50vw; top:0vw; width:100vw'>
		<table style='color:white; background-color:rgba(0,0,204,1)' border=0>
			<tr><td width=20%></td><td width=60%></td><td width=20%></td></tr>
			<tr height=100>
				<td colspan=2 style='background-color:none'>
					<input style='display:none; border:0' name=estado type=text value=EDITADO readonly>
...
<!-- *****************************************			 sección A			 ***************************************** -->
		...
		<table border=0>
			...
			<tr class=C>
				...
				<td><input type=radio name=B12 id=v12 value=NA "; if ($row['B12'] == 'NA') {echo 'checked';} echo "></td>
			...
			<tr class=C>
				...
				<td class=numero>13.</td><td class=B>Hay algún requisito legal especial?<input name=B13a value='$row[B13a]' maxlength=13 type=texto style=width:33% pattern=.{1,} onkeyup=mayuscula(this)></td>
			</tr>
<!--
			<tr class=C>
				<td colspan=4></td>
				<td class=B><input name=B13a value='$row[B13a]' maxlength=13 type=texto style=width:35% pattern=.{1,} onkeyup=mayuscula(this)></td>
			</tr>
-->
			<tr class=C>
		...
		<table border=0>
			...
			<tr>
				...
				<td><input name=B11c type=checkbox "; if ($row['B11c'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;PROTECCIÓN<br> &nbsp;RESPIRATORIA</td>
				<td></td>
			</tr>
			<tr><td height=30></td></tr>
			<tr>
				<td></td>
				<td><input name=B11d type=checkbox "; if ($row['B11d'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;PROTECCIÓN<br> &nbsp;AUDITIVA</td>
				<td><input name=B11e type=checkbox "; if ($row['B11e'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;PROTECCIÓN<br> &nbsp;FACIAL</td>
				<td><input name=B11f type=checkbox "; if ($row['B11f'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;ANTEOJOS DE<br> &nbsp;SEGURIDAD</td>
				<td></td>
			</tr>
			<tr><td height=30></td></tr>
			<tr>
				<td></td>
				<td><input name=B11i type=checkbox "; if ($row['B11i'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;ARNÉS DE<br> &nbsp;SEGURIDAD</td>
				<td><input name=B11j type=checkbox "; if ($row['B11j'] == 'on') {echo 'checked';} echo "></td><td class=B> &nbsp;SALVAVIDAS</td>
				<td></td><td class=B></td>
				<td></td>
			</tr>
			<tr height=30><td></td></tr>
		...
		<table border=0>
			...
			<tr>
				<td></td>
				<td style=text-align:right class=B>ZAPATOS Tipo&nbsp;</td><td><input name=B11g value='$row[B11g]' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td style=text-align:right class=B>GUANTES Tipo&nbsp;</td><td><input name=B11h value='$row[B11h]' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
			</tr>
			<tr height=10><td></td></tr>
			<tr>
				<td></td>
				<td style=text-align:right class=B>ROPA Tipo&nbsp;</td><td><input name=B11k value='$row[B11k]' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td style=text-align:right class=B>OTRO Tipo&nbsp;</td><td><input name=B11l value='$row[B11l]' maxlength=10 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
			</tr>
			<tr height=30><td></td></tr>
		</table>
		<table border=0>
			<tr><td width= 1%></td><td width=31.50%></td><td width= 1%></td><td width=31.50%></td><td width=25%></td><td width=10%></td></tr>
			<tr><td colspan=4 class=B>&nbsp;&nbsp;20. PRUEBA DE GASES</td></tr>
			<tr>
				<td></td>
				<td class=A><br>EQUIPO<br>					<input name=B20a value='$row[B20a]' maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td class=A><br>MARCA<br>						<input name=B20c value='$row[B20c]' maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B20e value='$row[B20e]' min='$row[B20e]' max='$row[B20e]' type=date></td>
				<td class=A>BUMP TEST<br>						<input name=B20g type=checkbox "; if ($row['B20g'] == 'on') {echo 'checked';} echo "></td>
			</tr>
			<tr height=10><td></td></tr>
			<tr>
				<td></td>
				<td class=A><br>EQUIPO<br>					<input name=B20b value='$row[B20b]' maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td></td>
				<td class=A><br>MARCA<br>						<input name=B20d value='$row[B20d]' maxlength=15 type=texto pattern=.{1,} onkeyup=mayuscula(this)></td>
				<td class=A>FECHA<br>CALIBRACIÓN<br><input name=B20f value='$row[B20f]' min='$row[B20f]' max='$row[B20f]' type=date></td>
				<td class=A>BUMP TEST<br>						<input name=B20h type=checkbox "; if ($row['B20h'] == 'on') {echo 'checked';} echo "></td>
			</tr>
		</table>
		<br>
...
<!-- 5 --> 	<div style='position:absolute; width:62.35%; left:36.90%; background-color:white; overflow:scroll'>
		<table border=1 bordercolor=#ff7000>
			...
			<tr height=70px>
				<td class=A><input name=B20A1 type=time  value='$row[B20A1]' required></td>
				<td class=A><input name=B20B1 type=texto value='$row[B20B1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric required></td>
				<td class=A><input name=B20C1 type=time  value='$row[B20C1]'></td>
				<td class=A><input name=B20D1 type=texto value='$row[B20D1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B20E1 type=time  value='$row[B20E1]'></td>
				<td class=A><input name=B20F1 type=texto value='$row[B20F1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B20G1 type=time  value='$row[B20G1]'></td>
				<td class=A><input name=B20H1 type=texto value='$row[B20H1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B20I1 type=time  value='$row[B20I1]'></td>
				<td class=A><input name=B20J1 type=texto value='$row[B20J1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B20K1 type=time  value='$row[B20K1]'></td>
				<td class=A><input name=B20L1 type=texto value='$row[B20L1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B20M1 type=time  value='$row[B20M1]'></td>
				<td class=A><input name=B20N1 type=texto value='$row[B20N1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
				<td class=A><input name=B20O1 type=time  value='$row[B20O1]'></td>
				<td class=A><input name=B20P1 type=texto value='$row[B20P1]' id=numero	maxlength=5 pattern=^([0-9]{1,2}(\.[0-9]{1,2})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B20A2 type=time  value='$row[B20A2]' required></td>
				<td class=A><input name=B20B2 type=texto value='$row[B20B2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric required></td>
				<td class=A><input name=B20C2 type=time  value='$row[B20C2]'></td>
				<td class=A><input name=B20D2 type=texto value='$row[B20D2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20E2 type=time  value='$row[B20E2]'></td>
				<td class=A><input name=B20F2 type=texto value='$row[B20F2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20G2 type=time  value='$row[B20G2]'></td>
				<td class=A><input name=B20H2 type=texto value='$row[B20H2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20I2 type=time  value='$row[B20I2]'></td>
				<td class=A><input name=B20J2 type=texto value='$row[B20J2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20K2 type=time  value='$row[B20K2]'></td>
				<td class=A><input name=B20L2 type=texto value='$row[B20L2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20M2 type=time  value='$row[B20M2]'></td>
				<td class=A><input name=B20N2 type=texto value='$row[B20N2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20O2 type=time  value='$row[B20O2]'></td>
				<td class=A><input name=B20P2 type=texto value='$row[B20P2]' id=numero maxlength=4 pattern=^([0-9]{1,2}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B20A3 type=time  value='$row[B20A3]' required></td>
				<td class=A><input name=B20B3 type=texto value='$row[B20B3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric required></td>
				<td class=A><input name=B20C3 type=time  value='$row[B20C3]'></td>
				<td class=A><input name=B20D3 type=texto value='$row[B20D3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B20E3 type=time  value='$row[B20E3]'></td>
				<td class=A><input name=B20F3 type=texto value='$row[B20F3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B20G3 type=time  value='$row[B20G3]'></td>
				<td class=A><input name=B20H3 type=texto value='$row[B20H3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B20I3 type=time  value='$row[B20I3]'></td>
				<td class=A><input name=B20J3 type=texto value='$row[B20J3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B20K3 type=time  value='$row[B20K3]'></td>
				<td class=A><input name=B20L3 type=texto value='$row[B20L3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B20M3 type=time  value='$row[B20M3]'></td>
				<td class=A><input name=B20N3 type=texto value='$row[B20N3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
				<td class=A><input name=B20O3 type=time  value='$row[B20O3]'></td>
				<td class=A><input name=B20P3 type=texto value='$row[B20P3]' id=numero maxlength=3 pattern=^(([0-9]){1,3}?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B20A4 type=time  value='$row[B20A4]' required></td>
				<td class=A><input name=B20B4 type=texto value='$row[B20B4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric required></td>
				<td class=A><input name=B20C4 type=time  value='$row[B20C4]'></td>
				<td class=A><input name=B20D4 type=texto value='$row[B20D4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B20E4 type=time  value='$row[B20E4]'></td>
				<td class=A><input name=B20F4 type=texto value='$row[B20F4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B20G4 type=time  value='$row[B20G4]'></td>
				<td class=A><input name=B20H4 type=texto value='$row[B20H4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B20I4 type=time  value='$row[B20I4]'></td>
				<td class=A><input name=B20J4 type=texto value='$row[B20J4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B20K4 type=time  value='$row[B20K4]'></td>
				<td class=A><input name=B20L4 type=texto value='$row[B20L4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B20M4 type=time  value='$row[B20M4]'></td>
				<td class=A><input name=B20N4 type=texto value='$row[B20N4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
				<td class=A><input name=B20O4 type=time  value='$row[B20O4]'></td>
				<td class=A><input name=B20P4 type=texto value='$row[B20P4]' id=numero maxlength=4 pattern=^(([0-9]){1,4}?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B20A5 type=time  value='$row[B20A5]' required></td>
				<td class=A><input name=B20B5 type=texto value='$row[B20B5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric required></td>
				<td class=A><input name=B20C5 type=time  value='$row[B20C5]'></td>
				<td class=A><input name=B20D5 type=texto value='$row[B20D5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20E5 type=time  value='$row[B20E5]'></td>
				<td class=A><input name=B20F5 type=texto value='$row[B20F5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20G5 type=time  value='$row[B20G5]'></td>
				<td class=A><input name=B20H5 type=texto value='$row[B20H5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20I5 type=time  value='$row[B20I5]'></td>
				<td class=A><input name=B20J5 type=texto value='$row[B20J5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20K5 type=time  value='$row[B20K5]'></td>
				<td class=A><input name=B20L5 type=texto value='$row[B20L5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20M5 type=time  value='$row[B20M5]'></td>
				<td class=A><input name=B20N5 type=texto value='$row[B20N5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
				<td class=A><input name=B20O5 type=time  value='$row[B20O5]'></td>
				<td class=A><input name=B20P5 type=texto value='$row[B20P5]' id=numero maxlength=3 pattern=^([0]{1}(\.[0-9]{1,1})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B20A6 type=time  value='$row[B20A6]' required></td>
				<td class=A><input name=B20B6 type=texto value='$row[B20B6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric required></td>
				<td class=A><input name=B20C6 type=time  value='$row[B20C6]'></td>
				<td class=A><input name=B20D6 type=texto value='$row[B20D6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B20E6 type=time  value='$row[B20E6]'></td>
				<td class=A><input name=B20F6 type=texto value='$row[B20F6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B20G6 type=time  value='$row[B20G6]'></td>
				<td class=A><input name=B20H6 type=texto value='$row[B20H6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B20I6 type=time  value='$row[B20I6]'></td>
				<td class=A><input name=B20J6 type=texto value='$row[B20J6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B20K6 type=time  value='$row[B20K6]'></td>
				<td class=A><input name=B20L6 type=texto value='$row[B20L6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B20M6 type=time  value='$row[B20M6]'></td>
				<td class=A><input name=B20N6 type=texto value='$row[B20N6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
				<td class=A><input name=B20O6 type=time  value='$row[B20O6]'></td>
				<td class=A><input name=B20P6 type=texto value='$row[B20P6]' id=numero maxlength=5 pattern=^([0]{1}(\.[0-9]{1,3})?)$ inputmode=numeric></td>
			</tr>
			<tr height=70px>
				<td class=A><input name=B20A7 type=time  value='$row[B20A7]' required></td>
				<td class=A><input name=B20B7 type=texto value='$row[B20B7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric required></td>
				<td class=A><input name=B20C7 type=time  value='$row[B20C7]'></td>
				<td class=A><input name=B20D7 type=texto value='$row[B20D7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B20E7 type=time  value='$row[B20E7]'></td>
				<td class=A><input name=B20F7 type=texto value='$row[B20F7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B20G7 type=time  value='$row[B20G7]'></td>
				<td class=A><input name=B20H7 type=texto value='$row[B20H7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B20I7 type=time  value='$row[B20I7]'></td>
				<td class=A><input name=B20J7 type=texto value='$row[B20J7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B20K7 type=time  value='$row[B20K7]'></td>
				<td class=A><input name=B20L7 type=texto value='$row[B20L7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B20M7 type=time  value='$row[B20M7]'></td>
				<td class=A><input name=B20N7 type=texto value='$row[B20N7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
				<td class=A><input name=B20O7 type=time  value='$row[B20O7]'></td>
				<td class=A><input name=B20P7 type=texto value='$row[B20P7]' id=numero maxlength=2 pattern=^(([0-9]){1,2}?)$ inputmode=numeric></td>
			</tr>
		</table>
<!-- /5 --> 	</div>
...
<!-- 10 --> 		<div style='position:relative; left:0px; width:100vw; top:220px'> <!-- este div mueve hacia abajo desde la sección C -->
		...
		<table border=0>
			...
			<tr>
				<td class=Bct>&nbsp;&nbsp;&#9679;&nbsp;</td>
				<td class=B>Certifico que los aislamientos y desacoples se han efectuado apropiadamente y que el área es segura para el ingreso.<br>Por lo tanto, <b>AUTORIZO</b> el ingreso al espacio confinado y la realización del trabajo indicado en la sección A.<br><br></td>
			</tr>
			<tr height=30><td></td></tr>
		</table>
		<table border=0>
