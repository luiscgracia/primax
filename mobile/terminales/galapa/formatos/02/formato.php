...
<div class=noimprimir>
	...
	<form id=formato name=formato method=post action=grabardatos.php enctype=application_x-www-form-urlencoded autocomplete=off>
		<div style="position:absolute; left:50%; margin-left:-50%; top:0%; width:100%; overflow:hidden; height:6040px; border:12px solid <?=$color_formato;?>">
				...
				echo '<table class=tabla22>
					...
					echo '<tr>';
						for($j = 0; $j < $columnas; $j++) {
							...
							$hora22 = '';
							echo "<td><input name=B22{$l[$j*2]}".($i+1)." 	value='$hora22' min='$horamin' type=time class='$class22' $q22></td>";
