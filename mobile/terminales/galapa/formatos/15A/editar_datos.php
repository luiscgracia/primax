...
<!--			<span style='font-size:24.00px; color:rgba(255,112,0,1)'><b>FORMATO WEB - Rev. Mayo 2014 / TERMINAL "; echo strtoupper($terminal); echo "</b></span><br> -->
		...
		<table border=1>
			...
			<tr>
				...
				<td class=A><input name=medicion_inicialA value='$row[medicion_inicialA]' type=text style='width:94%; text-align:center' maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_inicialB value='$row[medicion_inicialB]' type=text style='width:94%; text-align:center' maxlength=8 pattern=^(([0-9]){1,5}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_inicialC value='$row[medicion_inicialC]' type=text style='width:94%; text-align:center' maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_inicialD value='$row[medicion_inicialD]' type=text style='width:94%; text-align:center' maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_inicialE value='$row[medicion_inicialE]' type=text style='width:94%; text-align:center' maxlength=4 pattern=^(([0-9])(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A1>FINAL</td>
				<td class=A><input name=medicion_finalA value='$row[medicion_finalA]' type=text style='width:94%; text-align:center' maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_finalB value='$row[medicion_finalB]' type=text style='width:94%; text-align:center' maxlength=8 pattern=^(([0-9]){1,5}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_finalC value='$row[medicion_finalC]' type=text style='width:94%; text-align:center' maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_finalD value='$row[medicion_finalD]' type=text style='width:94%; text-align:center' maxlength=6 pattern=^(([0-9]){1,3}?(.\d)?(\d)?)$ inputmode=numeric required></td>
				<td class=A><input name=medicion_finalE value='$row[medicion_finalE]' type=text style='width:94%; text-align:center' maxlength=4 pattern=^(([0-9])(.\d)?(\d)?)$ inputmode=numeric required></td>
			</tr>
		</table>
...
<!-- hasta aquí va la tirilla media carta -->
		...
		<table border=1>
			<tr>
				<td style='width:20%; border:0'></td>
				<td style='width:19.50%; border:0'></td>
				<td style='width:19.50%; border:0'></td>
				<td style='width:19.50%; border:0'></td>
				<td style='width:21.50%; border:0'></td>
			</tr>
			<tr>
			...
			<tr>
				<td class=A>NIVEL</td>
				<td class=A><input name=nivel1_mt	value='$row[nivel1_mt]' type=text style='width:90%; text-align:center' maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel1_cm	value='$row[nivel1_cm]' type=text style='width:90%; text-align:center' maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel1_mm	value='$row[nivel1_mm]' type=text style='width:90%; text-align:center' maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td rowspan=2 class=A><input name=temperatura1 value='$row[temperatura1]' type=text style='width:90%; text-align:center' maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>AGUA</td>
				<td class=A><input name=agua1_mt	value='$row[agua1_mt]' type=text style='width:90%; text-align:center' maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=agua1_cm	value='$row[agua1_cm]' type=text style='width:90%; text-align:center' maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=agua1_mm	value='$row[agua1_mm]' type=text style='width:90%; text-align:center' maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
			</tr>
		</table>
		<table border=0>
			<tr>
		...
		<table border=1>
			...
			<tr>
				<td class=A>NIVEL</td>
				<td class=A><input name=nivel2_mt	value='$row[nivel2_mt]' type=text style='width:90%; text-align:center' maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
				<td class=A><input name=nivel2_cm	value='$row[nivel2_cm]' type=text style='width:90%; text-align:center' maxlength=2 pattern=^(?:[0-9]{0,2})$ inputmode=numeric required></td>
				<td class=A><input name=nivel2_mm	value='$row[nivel2_mm]' type=text style='width:90%; text-align:center' maxlength=1 pattern=^(?:[0-9]{0,1})$ inputmode=numeric required></td>
				<td rowspan=2 class=A><input name=temperatura2 value='$row[temperatura2]' type=text style='width:90%; text-align:center' maxlength=3 pattern=^(?:[0-9]{1,3})$ inputmode=numeric required></td>
			</tr>
			<tr>
				<td class=A>AGUA</td>
		...
		<table>
			...
			<tr><td><textarea name=observaciones type=text style=width:99% maxlength=500 onkeyup=mayuscula(this) pattern=.{1,}>$row[observaciones]</textarea></td></tr>
		</table>
		<hr>
		...
		<table border=0>
			...
			<tr>
				...
				<td class=A><input name=inicial5	value='$row[inicial5]'	id=inicial5 type=text style='width:95%; background-color:rgba(0,0,0,0); text-align:center' readonly></td>
				<td class=A><input name=final5		value='$row[final5]'		id=final5 	type=text style='width:95%; background-color:rgba(0,0,0,0); text-align:center' readonly></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class=A><input name=inicial9	value='$row[inicial9]'	id=inicial9 type=text style='width:95%; background-color:rgba(0,0,0,0); text-align:center' readonly></td>
				<td class=A><input name=final9		value='$row[final9]'		id=final9 	type=text style='width:95%; background-color:rgba(0,0,0,0); text-align:center' readonly></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan=5 class=LAleft><span style='font-size:23.00px'>&nbsp;13. FACTOR CORRECCIÓN 60°F&nbsp;<span style='font-size:20px'>(COEF. TABLA 6B)</span>&nbsp;CONTADORES</span></td>
			...
			<tr>
				<td colspan=5 class=Aleft><span style='font-size:23.10px'>&nbsp;14. VOLUMEN NETO ENTREGADO POR CONTADORES (11x13)</span></td>
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A><input name=final14	value='$row[final14]'			id=final14	type=text style='width:95%; background-color:rgba(0,0,0,0); text-align:center' readonly></td>
			</tr>
			<tr>
				<td colspan=5 class=Aleft>&nbsp;15. VOLUMEN NETO RECIBIDO (10+14)</td>
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A><input name=final15	value='$row[final15]'			id=final15	type=text style='width:95%; background-color:rgba(0,0,0,0); text-align:center' readonly></td>
			</tr>
			<tr>
			...
			<tr>
				<td class=Aleft>&nbsp;17. DIFERENCIA <span style='font-size:22.00px'>(15-16)</span>:</td>
				...
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A><input name=final17	value='$row[final17]'			id=final17	type=text style='width:95%; background-color:rgba(0,0,0,0); text-align:center' readonly></td>
			</tr>
			<tr>
				<td colspan=5 class=Aleft>&nbsp;18. PORCENTAJE DE VARIACION (17/16 x 100)</td>
				<td class=A style=background-color:rgba(192,192,192,1)></td>
				<td class=A style=text-align:center>
					<input name=final18	value='$row[final18]' id=final18	type=text style='width:70%; text-align:right; background-color:rgba(0,0,0,0); border:0' readonly><span style='font-size:28px; color:rgba(0,0,191,1)'>%</span>
				</td>
			</tr>
		...
		<table border=0>
			<tr>
				<td class=Anota>
					NOTA: Si el porcentaje (%) de variación es mayor o igual al ±0,25%, mida nuevamente el tanque y con estos datos realice una nueva liquidación. Si el porcentaje de variación es mayor a ±0,5% una vez haya realizado el paso anterior verifique que el resultado de la liquidación es correcto e informe al supervisor.
				</td>
			</tr>
		</table>
		<hr>
